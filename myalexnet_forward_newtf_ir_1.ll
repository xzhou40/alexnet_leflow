...
entry:
  ...
  %name.untyped = load i8*, i8** %0, !dereferenceable !1, !align !2
  ...
  %2 = load i64, i64* %dynamic_loop_bound_0
  %dynamic_loop_bound_1 = getelementptr i64, i64* %dynamic_loop_bounds, i64 1
  %3 = load i64, i64* %dynamic_loop_bound_1
...
slice.clone.loop_header.dim.0:                    ; preds = %slice.clone.loop_exit.dim.1, %entry
  %slice.clone.indvar.dim.0 = load i64, i64* %slice.clone.invar_address.dim.0
...
slice.clone.loop_header.dim.1:                    ; preds = %slice.clone.loop_exit.dim.2, %slice.clone.loop_body.dim.0
  %slice.clone.indvar.dim.1 = load i64, i64* %slice.clone.invar_address.dim.1
...
slice.clone.loop_header.dim.2:                    ; preds = %slice.clone.loop_exit.dim.3, %slice.clone.loop_body.dim.1
  %slice.clone.indvar.dim.2 = load i64, i64* %slice.clone.invar_address.dim.2
...
slice.clone.loop_header.dim.3:                    ; preds = %slice.clone.loop_body.dim.3, %slice.clone.loop_body.dim.2
  %slice.clone.indvar.dim.3 = load i64, i64* %slice.clone.invar_address.dim.3
...
slice.clone.loop_body.dim.3:                      ; preds = %slice.clone.loop_header.dim.3
  ...
  %12 = getelementptr inbounds [3 x [3 x [192 x [256 x float]]]], [3 x [3 x [192 x [256 x float]]]]* %1, i64 0, i64 %8, i64 %9, i64 %10, i64 %11
  %13 = load float, float* %12
  %14 = getelementptr inbounds [3 x [3 x [192 x [128 x float]]]], [3 x [3 x [192 x [128 x float]]]]* %slice.clone, i64 0, i64 %slice.clone.indvar.dim.0, i64 %slice.clone.indvar.dim.1, i64 %slice.clone.indvar.dim.2, i64 %slice.clone.indvar.dim.3
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.1.untyped = load i8*, i8** %0, !dereferenceable !3, !align !2
...
slice.1.clone.loop_header.dim.0:                  ; preds = %slice.1.clone.loop_exit.dim.1, %entry
  %slice.1.clone.indvar.dim.0 = load i64, i64* %slice.1.clone.invar_address.dim.0
...
slice.1.clone.loop_header.dim.1:                  ; preds = %slice.1.clone.loop_exit.dim.2, %slice.1.clone.loop_body.dim.0
  %slice.1.clone.indvar.dim.1 = load i64, i64* %slice.1.clone.invar_address.dim.1
...
slice.1.clone.loop_header.dim.2:                  ; preds = %slice.1.clone.loop_exit.dim.3, %slice.1.clone.loop_body.dim.1
  %slice.1.clone.indvar.dim.2 = load i64, i64* %slice.1.clone.invar_address.dim.2
...
slice.1.clone.loop_header.dim.3:                  ; preds = %slice.1.clone.loop_body.dim.3, %slice.1.clone.loop_body.dim.2
  %slice.1.clone.indvar.dim.3 = load i64, i64* %slice.1.clone.invar_address.dim.3
...
slice.1.clone.loop_body.dim.3:                    ; preds = %slice.1.clone.loop_header.dim.3
  ...
  %12 = getelementptr inbounds [3 x [3 x [192 x [384 x float]]]], [3 x [3 x [192 x [384 x float]]]]* %1, i64 0, i64 %8, i64 %9, i64 %10, i64 %11
  %13 = load float, float* %12
  %14 = getelementptr inbounds [3 x [3 x [192 x [192 x float]]]], [3 x [3 x [192 x [192 x float]]]]* %slice.1.clone, i64 0, i64 %slice.1.clone.indvar.dim.0, i64 %slice.1.clone.indvar.dim.1, i64 %slice.1.clone.indvar.dim.2, i64 %slice.1.clone.indvar.dim.3
  store float %13, float* %14
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.2.untyped = load i8*, i8** %0, !dereferenceable !4, !align !2
...
slice.2.clone.loop_header.dim.0:                  ; preds = %slice.2.clone.loop_exit.dim.1, %entry
  %slice.2.clone.indvar.dim.0 = load i64, i64* %slice.2.clone.invar_address.dim.0
...
slice.2.clone.loop_header.dim.1:                  ; preds = %slice.2.clone.loop_exit.dim.2, %slice.2.clone.loop_body.dim.0
  %slice.2.clone.indvar.dim.1 = load i64, i64* %slice.2.clone.invar_address.dim.1
...
slice.2.clone.loop_header.dim.2:                  ; preds = %slice.2.clone.loop_exit.dim.3, %slice.2.clone.loop_body.dim.1
  %slice.2.clone.indvar.dim.2 = load i64, i64* %slice.2.clone.invar_address.dim.2
...
slice.2.clone.loop_header.dim.3:                  ; preds = %slice.2.clone.loop_body.dim.3, %slice.2.clone.loop_body.dim.2
  %slice.2.clone.indvar.dim.3 = load i64, i64* %slice.2.clone.invar_address.dim.3
...
slice.2.clone.loop_body.dim.3:                    ; preds = %slice.2.clone.loop_header.dim.3
  ...
  %12 = getelementptr inbounds [5 x [5 x [48 x [256 x float]]]], [5 x [5 x [48 x [256 x float]]]]* %1, i64 0, i64 %8, i64 %9, i64 %10, i64 %11
  %13 = load float, float* %12
  %14 = getelementptr inbounds [5 x [5 x [48 x [128 x float]]]], [5 x [5 x [48 x [128 x float]]]]* %slice.2.clone, i64 0, i64 %slice.2.clone.indvar.dim.0, i64 %slice.2.clone.indvar.dim.1, i64 %slice.2.clone.indvar.dim.2, i64 %slice.2.clone.indvar.dim.3
  store float %13, float* %14
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.4.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.4.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.3.untyped = load i8*, i8** %2, !dereferenceable !5, !align !2
  %3 = bitcast i8* %name.3.untyped to [2 x [57 x [57 x [96 x float]]]]*
  %reduce-window.clone = bitcast i8* %retval to [2 x [57 x [57 x [96 x float]]]]*
  %dynamic_loop_bound_0 = getelementptr i64, i64* %dynamic_loop_bounds, i64 0
  %4 = load i64, i64* %dynamic_loop_bound_0
  %dynamic_loop_bound_1 = getelementptr i64, i64* %dynamic_loop_bounds, i64 1
  %5 = load i64, i64* %dynamic_loop_bound_1
...
reduce-window.clone.loop_header.dim.0:            ; preds = %reduce-window.clone.loop_exit.dim.1, %entry
  %reduce-window.clone.indvar.dim.0 = load i64, i64* %reduce-window.clone.invar_address.dim.0
...
reduce-window.clone.loop_header.dim.1:            ; preds = %reduce-window.clone.loop_exit.dim.2, %reduce-window.clone.loop_body.dim.0
  %reduce-window.clone.indvar.dim.1 = load i64, i64* %reduce-window.clone.invar_address.dim.1
...
reduce-window.clone.loop_header.dim.2:            ; preds = %reduce-window.clone.loop_exit.dim.3, %reduce-window.clone.loop_body.dim.1
  %reduce-window.clone.indvar.dim.2 = load i64, i64* %reduce-window.clone.invar_address.dim.2
...
reduce-window.clone.loop_header.dim.3:            ; preds = %reduce-window.clone.inner.loop_exit.window.0, %reduce-window.clone.loop_body.dim.2
  %reduce-window.clone.indvar.dim.3 = load i64, i64* %reduce-window.clone.invar_address.dim.3
...
reduce-window.clone.inner.loop_header.window.0:   ; preds = %reduce-window.clone.inner.loop_exit.window.1, %reduce-window.clone.loop_body.dim.3
  %reduce-window.clone.inner.indvar.window.0 = load i64, i64* %reduce-window.clone.inner.invar_address.window.0
...
reduce-window.clone.inner.loop_header.window.1:   ; preds = %reduce-window.clone.inner.loop_exit.window.2, %reduce-window.clone.inner.loop_body.window.0
  %reduce-window.clone.inner.indvar.window.1 = load i64, i64* %reduce-window.clone.inner.invar_address.window.1
...
reduce-window.clone.inner.loop_header.window.2:   ; preds = %reduce-window.clone.inner.loop_exit.window.3, %reduce-window.clone.inner.loop_body.window.1
  %reduce-window.clone.inner.indvar.window.2 = load i64, i64* %reduce-window.clone.inner.invar_address.window.2
...
reduce-window.clone.inner.loop_header.window.3:   ; preds = %in-bounds-after, %reduce-window.clone.inner.loop_body.window.2
  %reduce-window.clone.inner.indvar.window.3 = load i64, i64* %reduce-window.clone.inner.invar_address.window.3
...
reduce-window.clone.inner.loop_exit.window.0:     ; preds = %reduce-window.clone.inner.loop_header.window.0
  %34 = load float, float* %reduce_window_accumulator_address
  %35 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %reduce-window.clone, i64 0, i64 %reduce-window.clone.indvar.dim.0, i64 %reduce-window.clone.indvar.dim.1, i64 %reduce-window.clone.indvar.dim.2, i64 %reduce-window.clone.indvar.dim.3
...
in-bounds-true:                                   ; preds = %reduce-window.clone.inner.loop_body.window.3
  %36 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %3, i64 0, i64 %17, i64 %21, i64 %26, i64 %31
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.6.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.6.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.5.untyped = load i8*, i8** %2, !dereferenceable !5, !align !2
...
reduce-window.1.clone.loop_header.dim.0:          ; preds = %reduce-window.1.clone.loop_exit.dim.1, %entry
  %reduce-window.1.clone.indvar.dim.0 = load i64, i64* %reduce-window.1.clone.invar_address.dim.0
...
reduce-window.1.clone.loop_header.dim.1:          ; preds = %reduce-window.1.clone.loop_exit.dim.2, %reduce-window.1.clone.loop_body.dim.0
  %reduce-window.1.clone.indvar.dim.1 = load i64, i64* %reduce-window.1.clone.invar_address.dim.1
...
reduce-window.1.clone.loop_header.dim.2:          ; preds = %reduce-window.1.clone.loop_exit.dim.3, %reduce-window.1.clone.loop_body.dim.1
  %reduce-window.1.clone.indvar.dim.2 = load i64, i64* %reduce-window.1.clone.invar_address.dim.2
...
reduce-window.1.clone.loop_header.dim.3:          ; preds = %reduce-window.1.clone.inner.loop_exit.window.0, %reduce-window.1.clone.loop_body.dim.2
  %reduce-window.1.clone.indvar.dim.3 = load i64, i64* %reduce-window.1.clone.invar_address.dim.3
...
reduce-window.1.clone.inner.loop_header.window.0: ; preds = %reduce-window.1.clone.inner.loop_exit.window.1, %reduce-window.1.clone.loop_body.dim.3
  %reduce-window.1.clone.inner.indvar.window.0 = load i64, i64* %reduce-window.1.clone.inner.invar_address.window.0
...
reduce-window.1.clone.inner.loop_header.window.1: ; preds = %reduce-window.1.clone.inner.loop_exit.window.2, %reduce-window.1.clone.inner.loop_body.window.0
  %reduce-window.1.clone.inner.indvar.window.1 = load i64, i64* %reduce-window.1.clone.inner.invar_address.window.1
...
reduce-window.1.clone.inner.loop_header.window.2: ; preds = %reduce-window.1.clone.inner.loop_exit.window.3, %reduce-window.1.clone.inner.loop_body.window.1
  %reduce-window.1.clone.inner.indvar.window.2 = load i64, i64* %reduce-window.1.clone.inner.invar_address.window.2
...
reduce-window.1.clone.inner.loop_header.window.3: ; preds = %in-bounds-after, %reduce-window.1.clone.inner.loop_body.window.2
  %reduce-window.1.clone.inner.indvar.window.3 = load i64, i64* %reduce-window.1.clone.inner.invar_address.window.3
...
reduce-window.1.clone.inner.loop_exit.window.0:   ; preds = %reduce-window.1.clone.inner.loop_header.window.0
  %34 = load float, float* %reduce_window_accumulator_address
  %35 = getelementptr inbounds [2 x [28 x [28 x [96 x float]]]], [2 x [28 x [28 x [96 x float]]]]* %reduce-window.1.clone, i64 0, i64 %reduce-window.1.clone.indvar.dim.0, i64 %reduce-window.1.clone.indvar.dim.1, i64 %reduce-window.1.clone.indvar.dim.2, i64 %reduce-window.1.clone.indvar.dim.3
  store float %34, float* %35
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.7.untyped = load i8*, i8** %0, !dereferenceable !4, !align !2
...
slice.4.clone.loop_header.dim.0:                  ; preds = %slice.4.clone.loop_exit.dim.1, %entry
  %slice.4.clone.indvar.dim.0 = load i64, i64* %slice.4.clone.invar_address.dim.0
...
slice.4.clone.loop_header.dim.1:                  ; preds = %slice.4.clone.loop_exit.dim.2, %slice.4.clone.loop_body.dim.0
  %slice.4.clone.indvar.dim.1 = load i64, i64* %slice.4.clone.invar_address.dim.1
...
slice.4.clone.loop_header.dim.2:                  ; preds = %slice.4.clone.loop_exit.dim.3, %slice.4.clone.loop_body.dim.1
  %slice.4.clone.indvar.dim.2 = load i64, i64* %slice.4.clone.invar_address.dim.2
...
slice.4.clone.loop_header.dim.3:                  ; preds = %slice.4.clone.loop_body.dim.3, %slice.4.clone.loop_body.dim.2
  %slice.4.clone.indvar.dim.3 = load i64, i64* %slice.4.clone.invar_address.dim.3
...
slice.4.clone.loop_body.dim.3:                    ; preds = %slice.4.clone.loop_header.dim.3
  ...
  %12 = getelementptr inbounds [5 x [5 x [48 x [256 x float]]]], [5 x [5 x [48 x [256 x float]]]]* %1, i64 0, i64 %8, i64 %9, i64 %10, i64 %11
  %13 = load float, float* %12
  %14 = getelementptr inbounds [5 x [5 x [48 x [128 x float]]]], [5 x [5 x [48 x [128 x float]]]]* %slice.4.clone, i64 0, i64 %slice.4.clone.indvar.dim.0, i64 %slice.4.clone.indvar.dim.1, i64 %slice.4.clone.indvar.dim.2, i64 %slice.4.clone.indvar.dim.3
  store float %13, float* %14
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.9.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.9.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.8.untyped = load i8*, i8** %2, !dereferenceable !6, !align !2
...
reduce-window.2.clone.loop_header.dim.0:          ; preds = %reduce-window.2.clone.loop_exit.dim.1, %entry
  %reduce-window.2.clone.indvar.dim.0 = load i64, i64* %reduce-window.2.clone.invar_address.dim.0
...
reduce-window.2.clone.loop_header.dim.1:          ; preds = %reduce-window.2.clone.loop_exit.dim.2, %reduce-window.2.clone.loop_body.dim.0
  %reduce-window.2.clone.indvar.dim.1 = load i64, i64* %reduce-window.2.clone.invar_address.dim.1
...
reduce-window.2.clone.loop_header.dim.2:          ; preds = %reduce-window.2.clone.loop_exit.dim.3, %reduce-window.2.clone.loop_body.dim.1
  %reduce-window.2.clone.indvar.dim.2 = load i64, i64* %reduce-window.2.clone.invar_address.dim.2
...
reduce-window.2.clone.loop_header.dim.3:          ; preds = %reduce-window.2.clone.inner.loop_exit.window.0, %reduce-window.2.clone.loop_body.dim.2
  %reduce-window.2.clone.indvar.dim.3 = load i64, i64* %reduce-window.2.clone.invar_address.dim.3
...
reduce-window.2.clone.inner.loop_header.window.0: ; preds = %reduce-window.2.clone.inner.loop_exit.window.1, %reduce-window.2.clone.loop_body.dim.3
  %reduce-window.2.clone.inner.indvar.window.0 = load i64, i64* %reduce-window.2.clone.inner.invar_address.window.0
...
reduce-window.2.clone.inner.loop_header.window.1: ; preds = %reduce-window.2.clone.inner.loop_exit.window.2, %reduce-window.2.clone.inner.loop_body.window.0
  %reduce-window.2.clone.inner.indvar.window.1 = load i64, i64* %reduce-window.2.clone.inner.invar_address.window.1
...
reduce-window.2.clone.inner.loop_header.window.2: ; preds = %reduce-window.2.clone.inner.loop_exit.window.3, %reduce-window.2.clone.inner.loop_body.window.1
  %reduce-window.2.clone.inner.indvar.window.2 = load i64, i64* %reduce-window.2.clone.inner.invar_address.window.2
...
reduce-window.2.clone.inner.loop_header.window.3: ; preds = %in-bounds-after, %reduce-window.2.clone.inner.loop_body.window.2
  %reduce-window.2.clone.inner.indvar.window.3 = load i64, i64* %reduce-window.2.clone.inner.invar_address.window.3
...
reduce-window.2.clone.inner.loop_exit.window.0:   ; preds = %reduce-window.2.clone.inner.loop_header.window.0
  %34 = load float, float* %reduce_window_accumulator_address
  %35 = getelementptr inbounds [2 x [28 x [28 x [256 x float]]]], [2 x [28 x [28 x [256 x float]]]]* %reduce-window.2.clone, i64 0, i64 %reduce-window.2.clone.indvar.dim.0, i64 %reduce-window.2.clone.indvar.dim.1, i64 %reduce-window.2.clone.indvar.dim.2, i64 %reduce-window.2.clone.indvar.dim.3
  store float %34, float* %35
...
in-bounds-true:                                   ; preds = %reduce-window.2.clone.inner.loop_body.window.3
  %36 = getelementptr inbounds [2 x [28 x [28 x [256 x float]]]], [2 x [28 x [28 x [256 x float]]]]* %3, i64 0, i64 %17, i64 %21, i64 %26, i64 %31
  %reducer_function_parameter_0_address_as_i8ptr = bitcast float* %reduce_window_accumulator_address to i8*
  %37 = getelementptr inbounds i8*, i8** %reducer_function_parameter_addresses, i64 0
  store i8* %reducer_function_parameter_0_address_as_i8ptr, i8** %37
  %reducer_function_parameter_1_address_as_i8ptr = bitcast float* %36 to i8*
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.10.untyped = load i8*, i8** %0, !dereferenceable !3, !align !2
...
slice.7.clone.loop_header.dim.0:                  ; preds = %slice.7.clone.loop_exit.dim.1, %entry
  %slice.7.clone.indvar.dim.0 = load i64, i64* %slice.7.clone.invar_address.dim.0
...
slice.7.clone.loop_header.dim.1:                  ; preds = %slice.7.clone.loop_exit.dim.2, %slice.7.clone.loop_body.dim.0
  %slice.7.clone.indvar.dim.1 = load i64, i64* %slice.7.clone.invar_address.dim.1
...
slice.7.clone.loop_header.dim.2:                  ; preds = %slice.7.clone.loop_exit.dim.3, %slice.7.clone.loop_body.dim.1
  %slice.7.clone.indvar.dim.2 = load i64, i64* %slice.7.clone.invar_address.dim.2
...
slice.7.clone.loop_header.dim.3:                  ; preds = %slice.7.clone.loop_body.dim.3, %slice.7.clone.loop_body.dim.2
  %slice.7.clone.indvar.dim.3 = load i64, i64* %slice.7.clone.invar_address.dim.3
...
slice.7.clone.loop_body.dim.3:                    ; preds = %slice.7.clone.loop_header.dim.3
  ...
  %12 = getelementptr inbounds [3 x [3 x [192 x [384 x float]]]], [3 x [3 x [192 x [384 x float]]]]* %1, i64 0, i64 %8, i64 %9, i64 %10, i64 %11
  %13 = load float, float* %12
  %14 = getelementptr inbounds [3 x [3 x [192 x [192 x float]]]], [3 x [3 x [192 x [192 x float]]]]* %slice.7.clone, i64 0, i64 %slice.7.clone.indvar.dim.0, i64 %slice.7.clone.indvar.dim.1, i64 %slice.7.clone.indvar.dim.2, i64 %slice.7.clone.indvar.dim.3
  store float %13, float* %14
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.11.untyped = load i8*, i8** %0, !dereferenceable !1, !align !2
...
slice.10.clone.loop_header.dim.0:                 ; preds = %slice.10.clone.loop_exit.dim.1, %entry
  %slice.10.clone.indvar.dim.0 = load i64, i64* %slice.10.clone.invar_address.dim.0
...
slice.10.clone.loop_header.dim.1:                 ; preds = %slice.10.clone.loop_exit.dim.2, %slice.10.clone.loop_body.dim.0
  %slice.10.clone.indvar.dim.1 = load i64, i64* %slice.10.clone.invar_address.dim.1
...
slice.10.clone.loop_header.dim.2:                 ; preds = %slice.10.clone.loop_exit.dim.3, %slice.10.clone.loop_body.dim.1
  %slice.10.clone.indvar.dim.2 = load i64, i64* %slice.10.clone.invar_address.dim.2
...
slice.10.clone.loop_header.dim.3:                 ; preds = %slice.10.clone.loop_body.dim.3, %slice.10.clone.loop_body.dim.2
  %slice.10.clone.indvar.dim.3 = load i64, i64* %slice.10.clone.invar_address.dim.3
...
slice.10.clone.loop_body.dim.3:                   ; preds = %slice.10.clone.loop_header.dim.3
  ...
  %12 = getelementptr inbounds [3 x [3 x [192 x [256 x float]]]], [3 x [3 x [192 x [256 x float]]]]* %1, i64 0, i64 %8, i64 %9, i64 %10, i64 %11
  %13 = load float, float* %12
  %14 = getelementptr inbounds [3 x [3 x [192 x [128 x float]]]], [3 x [3 x [192 x [128 x float]]]]* %slice.10.clone, i64 0, i64 %slice.10.clone.indvar.dim.0, i64 %slice.10.clone.indvar.dim.1, i64 %slice.10.clone.indvar.dim.2, i64 %slice.10.clone.indvar.dim.3
  store float %13, float* %14
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 7
  %name.19.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.19.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 6
  %name.18.untyped = load i8*, i8** %2, !dereferenceable !7, !align !2
  %3 = bitcast i8* %name.18.untyped to [2 x [28 x [28 x [128 x float]]]]*
  %4 = getelementptr inbounds i8*, i8** %params, i64 5
  %name.17.untyped = load i8*, i8** %4, !dereferenceable !7, !align !2
  %5 = bitcast i8* %name.17.untyped to [2 x [28 x [28 x [128 x float]]]]*
  %6 = getelementptr inbounds i8*, i8** %params, i64 4
  %name.16.untyped = load i8*, i8** %6, !dereferenceable !8, !align !2
  %7 = bitcast i8* %name.16.untyped to [256 x float]*
  %8 = getelementptr inbounds i8*, i8** %params, i64 3
  %name.15.untyped = load i8*, i8** %8, !dereferenceable !0, !align !0
  %9 = bitcast i8* %name.15.untyped to float*
  %10 = getelementptr inbounds i8*, i8** %params, i64 2
  %name.14.untyped = load i8*, i8** %10, !dereferenceable !0, !align !0
  %11 = bitcast i8* %name.14.untyped to float*
  %12 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.13.untyped = load i8*, i8** %12, !dereferenceable !6, !align !2
  %13 = bitcast i8* %name.13.untyped to [2 x [28 x [28 x [256 x float]]]]*
  %14 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.12.untyped = load i8*, i8** %14, !dereferenceable !0, !align !0
  %15 = bitcast i8* %name.12.untyped to float*
  %fusion.10.clone = bitcast i8* %retval to [2 x [28 x [28 x [256 x float]]]]*
  %dynamic_loop_bound_0 = getelementptr i64, i64* %dynamic_loop_bounds, i64 0
  %16 = load i64, i64* %dynamic_loop_bound_0
  %dynamic_loop_bound_1 = getelementptr i64, i64* %dynamic_loop_bounds, i64 1
  %17 = load i64, i64* %dynamic_loop_bound_1
...
fusion.10.clone.loop_header.dim.0:                ; preds = %fusion.10.clone.loop_exit.dim.1, %entry
  %fusion.10.clone.indvar.dim.0 = load i64, i64* %fusion.10.clone.invar_address.dim.0
...
fusion.10.clone.loop_header.dim.1:                ; preds = %fusion.10.clone.loop_exit.dim.2, %fusion.10.clone.loop_body.dim.0
  %fusion.10.clone.indvar.dim.1 = load i64, i64* %fusion.10.clone.invar_address.dim.1
...
fusion.10.clone.loop_header.dim.2:                ; preds = %fusion.10.clone.loop_exit.dim.3, %fusion.10.clone.loop_body.dim.1
  %fusion.10.clone.indvar.dim.2 = load i64, i64* %fusion.10.clone.invar_address.dim.2
...
fusion.10.clone.loop_header.dim.3:                ; preds = %concatenate.8.merge, %fusion.10.clone.loop_body.dim.2
  %fusion.10.clone.indvar.dim.3 = load i64, i64* %fusion.10.clone.invar_address.dim.3
...
concat_index_from_operand0:                       ; preds = %fusion.10.clone.loop_body.dim.3
  %24 = getelementptr inbounds [2 x [28 x [28 x [128 x float]]]], [2 x [28 x [28 x [128 x float]]]]* %5, i64 0, i64 %fusion.10.clone.indvar.dim.0, i64 %fusion.10.clone.indvar.dim.1, i64 %fusion.10.clone.indvar.dim.2, i64 %fusion.10.clone.indvar.dim.3
...
concat_index_from_operand1:                       ; preds = %concat_index_not_from_operand0
  %28 = getelementptr inbounds [2 x [28 x [28 x [128 x float]]]], [2 x [28 x [28 x [128 x float]]]]* %3, i64 0, i64 %fusion.10.clone.indvar.dim.0, i64 %fusion.10.clone.indvar.dim.1, i64 %fusion.10.clone.indvar.dim.2, i64 %26
...
concatenate.8.merge:                              ; preds = %concat_index_from_operand1, %concat_index_from_operand0
  ...
  %32 = getelementptr inbounds [256 x float], [256 x float]* %7, i64 0, i64 %fusion.10.clone.indvar.dim.3
  ...
  %41 = getelementptr inbounds [2 x [28 x [28 x [256 x float]]]], [2 x [28 x [28 x [256 x float]]]]* %13, i64 0, i64 %fusion.10.clone.indvar.dim.0, i64 %fusion.10.clone.indvar.dim.1, i64 %fusion.10.clone.indvar.dim.2, i64 %fusion.10.clone.indvar.dim.3
  %42 = load float, float* %41
  %43 = fmul float %40, %42
  %44 = fadd float %39, %43
  %45 = load float, float* %15
  %46 = call float @llvm.pow.f32(float %44, float %45)
  %47 = fmul float %38, %46
  %48 = getelementptr inbounds [2 x [28 x [28 x [256 x float]]]], [2 x [28 x [28 x [256 x float]]]]* %fusion.10.clone, i64 0, i64 %fusion.10.clone.indvar.dim.0, i64 %fusion.10.clone.indvar.dim.1, i64 %fusion.10.clone.indvar.dim.2, i64 %fusion.10.clone.indvar.dim.3
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 3
  %name.23.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.23.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 2
  %name.22.untyped = load i8*, i8** %2, !dereferenceable !7, !align !2
  %3 = bitcast i8* %name.22.untyped to [2 x [28 x [28 x [128 x float]]]]*
  %4 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.21.untyped = load i8*, i8** %4, !dereferenceable !7, !align !2
  %5 = bitcast i8* %name.21.untyped to [2 x [28 x [28 x [128 x float]]]]*
  %6 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.20.untyped = load i8*, i8** %6, !dereferenceable !8, !align !2
  %7 = bitcast i8* %name.20.untyped to [256 x float]*
  %fusion.11.clone = bitcast i8* %retval to [2 x [28 x [28 x [256 x float]]]]*
  %dynamic_loop_bound_0 = getelementptr i64, i64* %dynamic_loop_bounds, i64 0
  %8 = load i64, i64* %dynamic_loop_bound_0
  %dynamic_loop_bound_1 = getelementptr i64, i64* %dynamic_loop_bounds, i64 1
  %9 = load i64, i64* %dynamic_loop_bound_1
...
fusion.11.clone.loop_header.dim.0:                ; preds = %fusion.11.clone.loop_exit.dim.1, %entry
  %fusion.11.clone.indvar.dim.0 = load i64, i64* %fusion.11.clone.invar_address.dim.0
...
fusion.11.clone.loop_header.dim.1:                ; preds = %fusion.11.clone.loop_exit.dim.2, %fusion.11.clone.loop_body.dim.0
  %fusion.11.clone.indvar.dim.1 = load i64, i64* %fusion.11.clone.invar_address.dim.1
...
fusion.11.clone.loop_header.dim.2:                ; preds = %fusion.11.clone.loop_exit.dim.3, %fusion.11.clone.loop_body.dim.1
  %fusion.11.clone.indvar.dim.2 = load i64, i64* %fusion.11.clone.invar_address.dim.2
...
fusion.11.clone.loop_header.dim.3:                ; preds = %concatenate.9.merge, %fusion.11.clone.loop_body.dim.2
  %fusion.11.clone.indvar.dim.3 = load i64, i64* %fusion.11.clone.invar_address.dim.3
...
concat_index_from_operand0:                       ; preds = %fusion.11.clone.loop_body.dim.3
  %16 = getelementptr inbounds [2 x [28 x [28 x [128 x float]]]], [2 x [28 x [28 x [128 x float]]]]* %5, i64 0, i64 %fusion.11.clone.indvar.dim.0, i64 %fusion.11.clone.indvar.dim.1, i64 %fusion.11.clone.indvar.dim.2, i64 %fusion.11.clone.indvar.dim.3
...
concat_index_from_operand1:                       ; preds = %concat_index_not_from_operand0
  %20 = getelementptr inbounds [2 x [28 x [28 x [128 x float]]]], [2 x [28 x [28 x [128 x float]]]]* %3, i64 0, i64 %fusion.11.clone.indvar.dim.0, i64 %fusion.11.clone.indvar.dim.1, i64 %fusion.11.clone.indvar.dim.2, i64 %18
...
concatenate.9.merge:                              ; preds = %concat_index_from_operand1, %concat_index_from_operand0
  ...
  %24 = getelementptr inbounds [256 x float], [256 x float]* %7, i64 0, i64 %fusion.11.clone.indvar.dim.3
  %25 = load float, float* %24
  %26 = fadd float %23, %25
  ...
  %31 = fmul float %30, %30
  %32 = getelementptr inbounds [2 x [28 x [28 x [256 x float]]]], [2 x [28 x [28 x [256 x float]]]]* %fusion.11.clone, i64 0, i64 %fusion.11.clone.indvar.dim.0, i64 %fusion.11.clone.indvar.dim.1, i64 %fusion.11.clone.indvar.dim.2, i64 %fusion.11.clone.indvar.dim.3
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 6
  %name.30.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.30.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 5
  %name.29.untyped = load i8*, i8** %2, !dereferenceable !9, !align !10
  %3 = bitcast i8* %name.29.untyped to [96 x float]*
  %4 = getelementptr inbounds i8*, i8** %params, i64 4
  %name.28.untyped = load i8*, i8** %4, !dereferenceable !5, !align !2
  %5 = bitcast i8* %name.28.untyped to [2 x [57 x [57 x [96 x float]]]]*
  %6 = getelementptr inbounds i8*, i8** %params, i64 3
  %name.27.untyped = load i8*, i8** %6, !dereferenceable !0, !align !0
  %7 = bitcast i8* %name.27.untyped to float*
  %8 = getelementptr inbounds i8*, i8** %params, i64 2
  %name.26.untyped = load i8*, i8** %8, !dereferenceable !0, !align !0
  %9 = bitcast i8* %name.26.untyped to float*
  %10 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.25.untyped = load i8*, i8** %10, !dereferenceable !5, !align !2
  %11 = bitcast i8* %name.25.untyped to [2 x [57 x [57 x [96 x float]]]]*
  %12 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.24.untyped = load i8*, i8** %12, !dereferenceable !0, !align !0
  %13 = bitcast i8* %name.24.untyped to float*
  %fusion.12.clone = bitcast i8* %retval to [2 x [57 x [57 x [96 x float]]]]*
  %dynamic_loop_bound_0 = getelementptr i64, i64* %dynamic_loop_bounds, i64 0
  %14 = load i64, i64* %dynamic_loop_bound_0
  %dynamic_loop_bound_1 = getelementptr i64, i64* %dynamic_loop_bounds, i64 1
  %15 = load i64, i64* %dynamic_loop_bound_1
...
fusion.12.clone.loop_header.dim.0:                ; preds = %fusion.12.clone.loop_exit.dim.1, %entry
  %fusion.12.clone.indvar.dim.0 = load i64, i64* %fusion.12.clone.invar_address.dim.0
...
fusion.12.clone.loop_header.dim.1:                ; preds = %fusion.12.clone.loop_exit.dim.2, %fusion.12.clone.loop_body.dim.0
  %fusion.12.clone.indvar.dim.1 = load i64, i64* %fusion.12.clone.invar_address.dim.1
...
fusion.12.clone.loop_header.dim.2:                ; preds = %fusion.12.clone.loop_exit.dim.3, %fusion.12.clone.loop_body.dim.1
  %fusion.12.clone.indvar.dim.2 = load i64, i64* %fusion.12.clone.invar_address.dim.2
...
fusion.12.clone.loop_header.dim.3:                ; preds = %fusion.12.clone.loop_body.dim.3, %fusion.12.clone.loop_body.dim.2
  %fusion.12.clone.indvar.dim.3 = load i64, i64* %fusion.12.clone.invar_address.dim.3
...
fusion.12.clone.loop_body.dim.3:                  ; preds = %fusion.12.clone.loop_header.dim.3
  ...
  %21 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %5, i64 0, i64 %fusion.12.clone.indvar.dim.0, i64 %fusion.12.clone.indvar.dim.1, i64 %fusion.12.clone.indvar.dim.2, i64 %fusion.12.clone.indvar.dim.3
  %22 = load float, float* %21
  %23 = getelementptr inbounds [96 x float], [96 x float]* %3, i64 0, i64 %fusion.12.clone.indvar.dim.3
  ...
  %30 = load float, float* %7
  %31 = load float, float* %9
  %32 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %11, i64 0, i64 %fusion.12.clone.indvar.dim.0, i64 %fusion.12.clone.indvar.dim.1, i64 %fusion.12.clone.indvar.dim.2, i64 %fusion.12.clone.indvar.dim.3
  %33 = load float, float* %32
  %34 = fmul float %31, %33
  %35 = fadd float %30, %34
  ...
  %38 = fmul float %29, %37
  %39 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %fusion.12.clone, i64 0, i64 %fusion.12.clone.indvar.dim.0, i64 %fusion.12.clone.indvar.dim.1, i64 %fusion.12.clone.indvar.dim.2, i64 %fusion.12.clone.indvar.dim.3
...
entry:
  ...
  %name.33.untyped = load i8*, i8** %0, !dereferenceable !0, !align !0
  %1 = bitcast i8* %name.33.untyped to float*
  %2 = getelementptr inbounds i8*, i8** %params, i64 1
  %name.32.untyped = load i8*, i8** %2, !dereferenceable !9, !align !10
  %3 = bitcast i8* %name.32.untyped to [96 x float]*
  %4 = getelementptr inbounds i8*, i8** %params, i64 0
  %name.31.untyped = load i8*, i8** %4, !dereferenceable !5, !align !2
  %5 = bitcast i8* %name.31.untyped to [2 x [57 x [57 x [96 x float]]]]*
  %fusion.13.clone = bitcast i8* %retval to [2 x [57 x [57 x [96 x float]]]]*
  %dynamic_loop_bound_0 = getelementptr i64, i64* %dynamic_loop_bounds, i64 0
  %6 = load i64, i64* %dynamic_loop_bound_0
  %dynamic_loop_bound_1 = getelementptr i64, i64* %dynamic_loop_bounds, i64 1
  %7 = load i64, i64* %dynamic_loop_bound_1
...
fusion.13.clone.loop_header.dim.0:                ; preds = %fusion.13.clone.loop_exit.dim.1, %entry
  %fusion.13.clone.indvar.dim.0 = load i64, i64* %fusion.13.clone.invar_address.dim.0
...
fusion.13.clone.loop_header.dim.1:                ; preds = %fusion.13.clone.loop_exit.dim.2, %fusion.13.clone.loop_body.dim.0
  %fusion.13.clone.indvar.dim.1 = load i64, i64* %fusion.13.clone.invar_address.dim.1
...
fusion.13.clone.loop_header.dim.2:                ; preds = %fusion.13.clone.loop_exit.dim.3, %fusion.13.clone.loop_body.dim.1
  %fusion.13.clone.indvar.dim.2 = load i64, i64* %fusion.13.clone.invar_address.dim.2
...
fusion.13.clone.loop_header.dim.3:                ; preds = %fusion.13.clone.loop_body.dim.3, %fusion.13.clone.loop_body.dim.2
  %fusion.13.clone.indvar.dim.3 = load i64, i64* %fusion.13.clone.invar_address.dim.3
...
fusion.13.clone.loop_body.dim.3:                  ; preds = %fusion.13.clone.loop_header.dim.3
  ...
  %13 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %5, i64 0, i64 %fusion.13.clone.indvar.dim.0, i64 %fusion.13.clone.indvar.dim.1, i64 %fusion.13.clone.indvar.dim.2, i64 %fusion.13.clone.indvar.dim.3
  %14 = load float, float* %13
  %15 = getelementptr inbounds [96 x float], [96 x float]* %3, i64 0, i64 %fusion.13.clone.indvar.dim.3
  ...
  %22 = fmul float %21, %21
  %23 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %fusion.13.clone, i64 0, i64 %fusion.13.clone.indvar.dim.0, i64 %fusion.13.clone.indvar.dim.1, i64 %fusion.13.clone.indvar.dim.2, i64 %fusion.13.clone.indvar.dim.3
...
entry:
  ...
  %0 = getelementptr inbounds i8*, i8** %params, i64 0
  %arg0.untyped = load i8*, i8** %0, !dereferenceable !11, !align !2
  %1 = bitcast i8* %arg0.untyped to [11 x [11 x [3 x [96 x float]]]]*
  %2 = getelementptr inbounds i8*, i8** %params, i64 16
  %arg16.untyped = load i8*, i8** %2, !dereferenceable !12, !align !2
  %3 = bitcast i8* %arg16.untyped to [2 x [227 x [227 x [3 x float]]]]*
  %4 = getelementptr inbounds i8*, i8** %temps, i64 25
  %5 = load i8*, i8** %4, !dereferenceable !13, !align !2
  %6 = getelementptr inbounds i8, i8* %5, i64 7202304
...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_header.k0
  %34 = load float, float* %convolution_sum_address
  %35 = getelementptr inbounds [2 x [57 x [57 x [96 x float]]]], [2 x [57 x [57 x [96 x float]]]]* %convolution, i64 0, i64 %convolution.indvar.dim.0, i64 %convolution.indvar.dim.1, i64 %convolution.indvar.dim.2, i64 %convolution.indvar.dim.3
  store float %34, float* %35
...
convolution.loop_exit.dim.0:                      ; preds = %convolution.loop_header.dim.0
  %36 = getelementptr inbounds i8*, i8** %params, i64 1
  %arg1.untyped = load i8*, i8** %36, !dereferenceable !9, !align !10
  %37 = bitcast i8* %arg1.untyped to [96 x float]*
  %38 = getelementptr inbounds i8*, i8** %temps, i64 25
  %39 = load i8*, i8** %38, !dereferenceable !13, !align !2
  %40 = getelementptr inbounds i8, i8* %39, i64 11918016
  ...
  %41 = getelementptr inbounds i8*, i8** %parallel_fusion.13_parameter_addresses, i64 0
  ...
  %42 = getelementptr inbounds i8*, i8** %parallel_fusion.13_parameter_addresses, i64 1
  store i8* %parallel_fusion.13_parameter_1_address_as_i8ptr, i8** %42
  %43 = getelementptr inbounds i8*, i8** %parallel_fusion.13_parameter_addresses, i64 2
  store i8* bitcast (float* @0 to i8*), i8** %43
  %44 = bitcast [2 x [57 x [57 x [96 x float]]]]* %call.12 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %44, i8* %run_options, i8** %parallel_fusion.13_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_fusion.13_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_fusion.13 to i8*))
  %45 = getelementptr inbounds i8*, i8** %temps, i64 25
  %46 = load i8*, i8** %45, !dereferenceable !13, !align !2
  %47 = getelementptr inbounds i8, i8* %46, i64 16620992
  ...
  %48 = getelementptr inbounds i8*, i8** %parallel_reduce-window_parameter_addresses, i64 0
  store i8* %parallel_reduce-window_parameter_0_address_as_i8ptr, i8** %48
  %49 = getelementptr inbounds i8*, i8** %parallel_reduce-window_parameter_addresses, i64 1
  store i8* bitcast (float* @0 to i8*), i8** %49
  %50 = bitcast [2 x [57 x [57 x [96 x float]]]]* %call.3 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %50, i8* %run_options, i8** %parallel_reduce-window_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_reduce-window_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_reduce-window to i8*))
  %51 = getelementptr inbounds i8*, i8** %temps, i64 25
  %52 = load i8*, i8** %51, !dereferenceable !13, !align !2
  %53 = getelementptr inbounds i8, i8* %52, i64 11918016
  %call.11 = bitcast i8* %53 to [2 x [57 x [57 x [96 x float]]]]*
  %54 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 0
  ...
  %55 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 1
  store i8* %parallel_fusion.12_parameter_1_address_as_i8ptr, i8** %55
  %56 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 2
  store i8* bitcast (float* @2 to i8*), i8** %56
  %57 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 3
  ...
  %58 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 4
  ...
  %59 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 5
  store i8* %parallel_fusion.12_parameter_5_address_as_i8ptr, i8** %59
  %60 = getelementptr inbounds i8*, i8** %parallel_fusion.12_parameter_addresses, i64 6
  store i8* bitcast (float* @0 to i8*), i8** %60
  %61 = bitcast [2 x [57 x [57 x [96 x float]]]]* %call.11 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %61, i8* %run_options, i8** %parallel_fusion.12_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_fusion.12_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_fusion.12 to i8*))
  %62 = getelementptr inbounds i8*, i8** %temps, i64 25
  %63 = load i8*, i8** %62, !dereferenceable !13, !align !2
  %64 = getelementptr inbounds i8, i8* %63, i64 16018880
  ...
  %65 = getelementptr inbounds i8*, i8** %parallel_reduce-window.1_parameter_addresses, i64 0
  store i8* %parallel_reduce-window.1_parameter_0_address_as_i8ptr, i8** %65
  %66 = getelementptr inbounds i8*, i8** %parallel_reduce-window.1_parameter_addresses, i64 1
  store i8* bitcast (float* @4 to i8*), i8** %66
  %67 = bitcast [2 x [28 x [28 x [96 x float]]]]* %call.4 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %67, i8* %run_options, i8** %parallel_reduce-window.1_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_reduce-window.1_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_reduce-window.1 to i8*))
  %68 = getelementptr inbounds i8*, i8** %temps, i64 25
  %69 = load i8*, i8** %68, !dereferenceable !13, !align !2
  %70 = getelementptr inbounds i8, i8* %69, i64 3440640
...
in-bounds-true:                                   ; preds = %convolution.inner.loop_body.iz
  %71 = getelementptr inbounds [11 x [11 x [3 x [96 x float]]]], [11 x [11 x [3 x [96 x float]]]]* %1, i64 0, i64 %convolution.inner.indvar.k0, i64 %convolution.inner.indvar.k1, i64 %convolution.inner.indvar.iz, i64 %convolution.indvar.dim.3
  %72 = load float, float* %71
  %73 = getelementptr inbounds [2 x [227 x [227 x [3 x float]]]], [2 x [227 x [227 x [3 x float]]]]* %3, i64 0, i64 %convolution.indvar.dim.0, i64 %32, i64 %33, i64 %convolution.inner.indvar.iz
  %74 = load float, float* %73
  %75 = fmul float %74, %72
  %76 = load float, float* %convolution_sum_address
  %77 = fadd float %76, %75
...
slice.3.loop_header.slice.0:                      ; preds = %slice.3.loop_exit.slice.1, %convolution.loop_exit.dim.0
  %slice.3.indvar.slice.0 = load i64, i64* %slice.3.invar_address.slice.0
...
slice.3.loop_header.slice.1:                      ; preds = %slice.3.loop_exit.slice.2, %slice.3.loop_body.slice.0
  %slice.3.indvar.slice.1 = load i64, i64* %slice.3.invar_address.slice.1
...
slice.3.loop_header.slice.2:                      ; preds = %slice.3.loop_body.slice.2, %slice.3.loop_body.slice.1
  %slice.3.indvar.slice.2 = load i64, i64* %slice.3.invar_address.slice.2
...
slice.3.loop_body.slice.2:                        ; preds = %slice.3.loop_header.slice.2
  ...
  %slice.dest = getelementptr inbounds [2 x [28 x [28 x [48 x float]]]], [2 x [28 x [28 x [48 x float]]]]* %slice.3, i64 0, i64 %slice.3.indvar.slice.0, i64 %slice.3.indvar.slice.1, i64 %slice.3.indvar.slice.2, i64 0
  %slice.source = getelementptr inbounds [2 x [28 x [28 x [96 x float]]]], [2 x [28 x [28 x [96 x float]]]]* %call.4, i64 0, i64 %81, i64 %82, i64 %83, i64 48
  %84 = bitcast float* %slice.dest to i8*
  %85 = bitcast float* %slice.source to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %84, i8* align 4 %85, i64 192, i1 false)
...
slice.3.loop_exit.slice.0:                        ; preds = %slice.3.loop_header.slice.0
  %86 = getelementptr inbounds i8*, i8** %params, i64 4
  %arg4.untyped = load i8*, i8** %86, !dereferenceable !4, !align !2
  %87 = bitcast i8* %arg4.untyped to [5 x [5 x [48 x [256 x float]]]]*
  %88 = getelementptr inbounds i8*, i8** %temps, i64 25
  %89 = load i8*, i8** %88, !dereferenceable !13, !align !2
  %90 = getelementptr inbounds i8, i8* %89, i64 11303616
  ...
  %91 = getelementptr inbounds i8*, i8** %parallel_slice.2_parameter_addresses, i64 0
  store i8* %parallel_slice.2_parameter_0_address_as_i8ptr, i8** %91
  %92 = bitcast [5 x [5 x [48 x [128 x float]]]]* %call.2 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %92, i8* %run_options, i8** %parallel_slice.2_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_slice.2_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_slice.2 to i8*))
  %93 = getelementptr inbounds i8*, i8** %temps, i64 25
  %94 = load i8*, i8** %93, !dereferenceable !13, !align !2
  %95 = getelementptr inbounds i8, i8* %94, i64 2211840
...
convolution.1.loop_header.dim.0:                  ; preds = %convolution.1.loop_exit.dim.1, %slice.3.loop_exit.slice.0
  %convolution.1.indvar.dim.0 = load i64, i64* %convolution.1.invar_address.dim.0
...
convolution.1.loop_header.dim.1:                  ; preds = %convolution.1.loop_exit.dim.2, %convolution.1.loop_body.dim.0
  %convolution.1.indvar.dim.1 = load i64, i64* %convolution.1.invar_address.dim.1
...
convolution.1.loop_header.dim.2:                  ; preds = %convolution.1.loop_exit.dim.3, %convolution.1.loop_body.dim.1
  %convolution.1.indvar.dim.2 = load i64, i64* %convolution.1.invar_address.dim.2
...
convolution.1.loop_header.dim.3:                  ; preds = %convolution.1.inner.loop_exit.k0, %convolution.1.loop_body.dim.2
  %convolution.1.indvar.dim.3 = load i64, i64* %convolution.1.invar_address.dim.3
...
convolution.1.inner.loop_header.k0:               ; preds = %convolution.1.inner.loop_exit.k1, %convolution.1.loop_body.dim.3
  %convolution.1.inner.indvar.k0 = load i64, i64* %convolution.1.inner.invar_address.k0
...
convolution.1.inner.loop_header.k1:               ; preds = %convolution.1.inner.loop_exit.iz, %convolution.1.inner.loop_body.k0
  %convolution.1.inner.indvar.k1 = load i64, i64* %convolution.1.inner.invar_address.k1
...
convolution.1.inner.loop_header.iz:               ; preds = %in-bounds-after20, %convolution.1.inner.loop_body.k1
  %convolution.1.inner.indvar.iz = load i64, i64* %convolution.1.inner.invar_address.iz
...
convolution.1.inner.loop_exit.k0:                 ; preds = %convolution.1.inner.loop_header.k0
  %123 = load float, float* %convolution_sum_address14
  %124 = getelementptr inbounds [2 x [28 x [28 x [128 x float]]]], [2 x [28 x [28 x [128 x float]]]]* %convolution.1, i64 0, i64 %convolution.1.indvar.dim.0, i64 %convolution.1.indvar.dim.1, i64 %convolution.1.indvar.dim.2, i64 %convolution.1.indvar.dim.3
...
convolution.1.loop_exit.dim.0:                    ; preds = %convolution.1.loop_header.dim.0
  %125 = getelementptr inbounds i8*, i8** %temps, i64 25
  %126 = load i8*, i8** %125, !dereferenceable !13, !align !2
  %127 = getelementptr inbounds i8, i8* %126, i64 4243456
...
in-bounds-true18:                                 ; preds = %convolution.1.inner.loop_body.iz
  %128 = getelementptr inbounds [5 x [5 x [48 x [128 x float]]]], [5 x [5 x [48 x [128 x float]]]]* %call.2, i64 0, i64 %convolution.1.inner.indvar.k0, i64 %convolution.1.inner.indvar.k1, i64 %convolution.1.inner.indvar.iz, i64 %convolution.1.indvar.dim.3
  %129 = load float, float* %128
  %130 = getelementptr inbounds [2 x [28 x [28 x [48 x float]]]], [2 x [28 x [28 x [48 x float]]]]* %slice.3, i64 0, i64 %convolution.1.indvar.dim.0, i64 %121, i64 %122, i64 %convolution.1.inner.indvar.iz
  %131 = load float, float* %130
  %132 = fmul float %131, %129
  %133 = load float, float* %convolution_sum_address14
...
slice.5.loop_header.slice.0:                      ; preds = %slice.5.loop_exit.slice.1, %convolution.1.loop_exit.dim.0
  %slice.5.indvar.slice.0 = load i64, i64* %slice.5.invar_address.slice.0
...
slice.5.loop_header.slice.1:                      ; preds = %slice.5.loop_exit.slice.2, %slice.5.loop_body.slice.0
  %slice.5.indvar.slice.1 = load i64, i64* %slice.5.invar_address.slice.1
...
slice.5.loop_header.slice.2:                      ; preds = %slice.5.loop_body.slice.2, %slice.5.loop_body.slice.1
  %slice.5.indvar.slice.2 = load i64, i64* %slice.5.invar_address.slice.2
...
slice.5.loop_body.slice.2:                        ; preds = %slice.5.loop_header.slice.2
  ...
  %slice.dest24 = getelementptr inbounds [2 x [28 x [28 x [48 x float]]]], [2 x [28 x [28 x [48 x float]]]]* %slice.5, i64 0, i64 %slice.5.indvar.slice.0, i64 %slice.5.indvar.slice.1, i64 %slice.5.indvar.slice.2, i64 0
  %slice.source25 = getelementptr inbounds [2 x [28 x [28 x [96 x float]]]], [2 x [28 x [28 x [96 x float]]]]* %call.4, i64 0, i64 %138, i64 %139, i64 %140, i64 0
  %141 = bitcast float* %slice.dest24 to i8*
  %142 = bitcast float* %slice.source25 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 4 %141, i8* align 4 %142, i64 192, i1 false)
...
slice.5.loop_exit.slice.0:                        ; preds = %slice.5.loop_header.slice.0
  %143 = getelementptr inbounds i8*, i8** %temps, i64 25
  %144 = load i8*, i8** %143, !dereferenceable !13, !align !2
  %145 = getelementptr inbounds i8, i8* %144, i64 11303616
  ...
  %146 = getelementptr inbounds i8*, i8** %parallel_slice.4_parameter_addresses, i64 0
  store i8* %parallel_slice.4_parameter_0_address_as_i8ptr, i8** %146
  %147 = bitcast [5 x [5 x [48 x [128 x float]]]]* %call.5 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %147, i8* %run_options, i8** %parallel_slice.4_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_slice.4_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_slice.4 to i8*))
  %148 = getelementptr inbounds i8*, i8** %temps, i64 25
  %149 = load i8*, i8** %148, !dereferenceable !13, !align !2
  %150 = getelementptr inbounds i8, i8* %149, i64 3014656
...
convolution.2.loop_header.dim.0:                  ; preds = %convolution.2.loop_exit.dim.1, %slice.5.loop_exit.slice.0
  %convolution.2.indvar.dim.0 = load i64, i64* %convolution.2.invar_address.dim.0
...
convolution.2.loop_header.dim.1:                  ; preds = %convolution.2.loop_exit.dim.2, %convolution.2.loop_body.dim.0
  %convolution.2.indvar.dim.1 = load i64, i64* %convolution.2.invar_address.dim.1
...
convolution.2.loop_header.dim.2:                  ; preds = %convolution.2.loop_exit.dim.3, %convolution.2.loop_body.dim.1
  %convolution.2.indvar.dim.2 = load i64, i64* %convolution.2.invar_address.dim.2
...
convolution.2.loop_header.dim.3:                  ; preds = %convolution.2.inner.loop_exit.k0, %convolution.2.loop_body.dim.2
  %convolution.2.indvar.dim.3 = load i64, i64* %convolution.2.invar_address.dim.3
...
convolution.2.inner.loop_header.k0:               ; preds = %convolution.2.inner.loop_exit.k1, %convolution.2.loop_body.dim.3
  %convolution.2.inner.indvar.k0 = load i64, i64* %convolution.2.inner.invar_address.k0
...
convolution.2.inner.loop_header.k1:               ; preds = %convolution.2.inner.loop_exit.iz, %convolution.2.inner.loop_body.k0
  %convolution.2.inner.indvar.k1 = load i64, i64* %convolution.2.inner.invar_address.k1
...
convolution.2.inner.loop_header.iz:               ; preds = %in-bounds-after36, %convolution.2.inner.loop_body.k1
  %convolution.2.inner.indvar.iz = load i64, i64* %convolution.2.inner.invar_address.iz
...
convolution.2.inner.loop_exit.k0:                 ; preds = %convolution.2.inner.loop_header.k0
  %178 = load float, float* %convolution_sum_address30
  %179 = getelementptr inbounds [2 x [28 x [28 x [128 x float]]]], [2 x [28 x [28 x [128 x float]]]]* %convolution.2, i64 0, i64 %convolution.2.indvar.dim.0, i64 %convolution.2.indvar.dim.1, i64 %convolution.2.indvar.dim.2, i64 %convolution.2.indvar.dim.3
...
convolution.2.loop_exit.dim.0:                    ; preds = %convolution.2.loop_header.dim.0
  %180 = getelementptr inbounds i8*, i8** %params, i64 5
  %arg5.untyped = load i8*, i8** %180, !dereferenceable !8, !align !2
  %181 = bitcast i8* %arg5.untyped to [256 x float]*
  %182 = getelementptr inbounds i8*, i8** %temps, i64 25
  %183 = load i8*, i8** %182, !dereferenceable !13, !align !2
  %184 = getelementptr inbounds i8, i8* %183, i64 9697984
  ...
  %185 = getelementptr inbounds i8*, i8** %parallel_fusion.11_parameter_addresses, i64 0
  ...
  %186 = getelementptr inbounds i8*, i8** %parallel_fusion.11_parameter_addresses, i64 1
  ...
  %187 = getelementptr inbounds i8*, i8** %parallel_fusion.11_parameter_addresses, i64 2
  store i8* %parallel_fusion.11_parameter_2_address_as_i8ptr, i8** %187
  %188 = getelementptr inbounds i8*, i8** %parallel_fusion.11_parameter_addresses, i64 3
  store i8* bitcast (float* @0 to i8*), i8** %188
  %189 = bitcast [2 x [28 x [28 x [256 x float]]]]* %call.10 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %189, i8* %run_options, i8** %parallel_fusion.11_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_fusion.11_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_fusion.11 to i8*))
  %190 = getelementptr inbounds i8*, i8** %temps, i64 25
  %191 = load i8*, i8** %190, !dereferenceable !13, !align !2
  %192 = getelementptr inbounds i8, i8* %191, i64 14413248
  ...
  %193 = getelementptr inbounds i8*, i8** %parallel_reduce-window.2_parameter_addresses, i64 0
  store i8* %parallel_reduce-window.2_parameter_0_address_as_i8ptr, i8** %193
  %194 = getelementptr inbounds i8*, i8** %parallel_reduce-window.2_parameter_addresses, i64 1
  store i8* bitcast (float* @0 to i8*), i8** %194
  %195 = bitcast [2 x [28 x [28 x [256 x float]]]]* %call.6 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %195, i8* %run_options, i8** %parallel_reduce-window.2_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_reduce-window.2_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_reduce-window.2 to i8*))
  %196 = getelementptr inbounds i8*, i8** %temps, i64 25
  %197 = load i8*, i8** %196, !dereferenceable !13, !align !2
  %198 = getelementptr inbounds i8, i8* %197, i64 9697984
  %call.9 = bitcast i8* %198 to [2 x [28 x [28 x [256 x float]]]]*
  %199 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 0
  ...
  %200 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 1
  store i8* %parallel_fusion.10_parameter_1_address_as_i8ptr, i8** %200
  %201 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 2
  store i8* bitcast (float* @2 to i8*), i8** %201
  %202 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 3
  store i8* bitcast (float* @1 to i8*), i8** %202
  %parallel_fusion.10_parameter_4_address_as_i8ptr = bitcast [256 x float]* %181 to i8*
  %203 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 4
  ...
  %204 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 5
  ...
  %205 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 6
  store i8* %parallel_fusion.10_parameter_6_address_as_i8ptr, i8** %205
  %206 = getelementptr inbounds i8*, i8** %parallel_fusion.10_parameter_addresses, i64 7
  store i8* bitcast (float* @0 to i8*), i8** %206
  %207 = bitcast [2 x [28 x [28 x [256 x float]]]]* %call.9 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %207, i8* %run_options, i8** %parallel_fusion.10_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_fusion.10_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_fusion.10 to i8*))
  %208 = getelementptr inbounds i8*, i8** %temps, i64 25
  %209 = load i8*, i8** %208, !dereferenceable !13, !align !2
  %210 = getelementptr inbounds i8, i8* %209, i64 2731008
...
in-bounds-true34:                                 ; preds = %convolution.2.inner.loop_body.iz
  %211 = getelementptr inbounds [5 x [5 x [48 x [128 x float]]]], [5 x [5 x [48 x [128 x float]]]]* %call.5, i64 0, i64 %convolution.2.inner.indvar.k0, i64 %convolution.2.inner.indvar.k1, i64 %convolution.2.inner.indvar.iz, i64 %convolution.2.indvar.dim.3
  %212 = load float, float* %211
  %213 = getelementptr inbounds [2 x [28 x [28 x [48 x float]]]], [2 x [28 x [28 x [48 x float]]]]* %slice.5, i64 0, i64 %convolution.2.indvar.dim.0, i64 %176, i64 %177, i64 %convolution.2.inner.indvar.iz
  %214 = load float, float* %213
  %215 = fmul float %214, %212
  %216 = load float, float* %convolution_sum_address30
...
reduce-window.3.loop_header.dim.0:                ; preds = %reduce-window.3.loop_exit.dim.1, %convolution.2.loop_exit.dim.0
  %reduce-window.3.indvar.dim.0 = load i64, i64* %reduce-window.3.invar_address.dim.0
...
reduce-window.3.loop_header.dim.1:                ; preds = %reduce-window.3.loop_exit.dim.2, %reduce-window.3.loop_body.dim.0
  %reduce-window.3.indvar.dim.1 = load i64, i64* %reduce-window.3.invar_address.dim.1
...
reduce-window.3.loop_header.dim.2:                ; preds = %reduce-window.3.loop_exit.dim.3, %reduce-window.3.loop_body.dim.1
  %reduce-window.3.indvar.dim.2 = load i64, i64* %reduce-window.3.invar_address.dim.2
...
reduce-window.3.loop_header.dim.3:                ; preds = %reduce-window.3.inner.loop_exit.window.0, %reduce-window.3.loop_body.dim.2
  %reduce-window.3.indvar.dim.3 = load i64, i64* %reduce-window.3.invar_address.dim.3
...
reduce-window.3.inner.loop_header.window.0:       ; preds = %reduce-window.3.inner.loop_exit.window.1, %reduce-window.3.loop_body.dim.3
  %reduce-window.3.inner.indvar.window.0 = load i64, i64* %reduce-window.3.inner.invar_address.window.0
...
reduce-window.3.inner.loop_header.window.1:       ; preds = %reduce-window.3.inner.loop_exit.window.2, %reduce-window.3.inner.loop_body.window.0
  %reduce-window.3.inner.indvar.window.1 = load i64, i64* %reduce-window.3.inner.invar_address.window.1
...
reduce-window.3.inner.loop_header.window.2:       ; preds = %reduce-window.3.inner.loop_exit.window.3, %reduce-window.3.inner.loop_body.window.1
  %reduce-window.3.inner.indvar.window.2 = load i64, i64* %reduce-window.3.inner.invar_address.window.2
...
reduce-window.3.inner.loop_header.window.3:       ; preds = %in-bounds-after47, %reduce-window.3.inner.loop_body.window.2
  %reduce-window.3.inner.indvar.window.3 = load i64, i64* %reduce-window.3.inner.invar_address.window.3
...
reduce-window.3.inner.loop_exit.window.0:         ; preds = %reduce-window.3.inner.loop_header.window.0
  %246 = load float, float* %reduce_window_accumulator_address
  %247 = getelementptr inbounds [2 x [13 x [13 x [256 x float]]]], [2 x [13 x [13 x [256 x float]]]]* %reduce-window.3, i64 0, i64 %reduce-window.3.indvar.dim.0, i64 %reduce-window.3.indvar.dim.1, i64 %reduce-window.3.indvar.dim.2, i64 %reduce-window.3.indvar.dim.3
...
reduce-window.3.loop_exit.dim.0:                  ; preds = %reduce-window.3.loop_header.dim.0
  %248 = getelementptr inbounds i8*, i8** %params, i64 6
  %arg6.untyped = load i8*, i8** %248, !dereferenceable !14, !align !2
  %249 = bitcast i8* %arg6.untyped to [3 x [3 x [256 x [384 x float]]]]*
  %250 = getelementptr inbounds i8*, i8** %temps, i64 25
  %251 = load i8*, i8** %250, !dereferenceable !13, !align !2
  %252 = getelementptr inbounds i8, i8* %251, i64 2211840
...
in-bounds-true45:                                 ; preds = %reduce-window.3.inner.loop_body.window.3
  %253 = getelementptr inbounds [2 x [28 x [28 x [256 x float]]]], [2 x [28 x [28 x [256 x float]]]]* %call.9, i64 0, i64 %229, i64 %233, i64 %238, i64 %243
  %reducer_function_parameter_0_address_as_i8ptr = bitcast float* %reduce_window_accumulator_address to i8*
  %254 = getelementptr inbounds i8*, i8** %reducer_function_parameter_addresses, i64 0
  ...
  %255 = getelementptr inbounds i8*, i8** %reducer_function_parameter_addresses, i64 1
...
convolution.3.loop_header.dim.0:                  ; preds = %convolution.3.loop_exit.dim.1, %reduce-window.3.loop_exit.dim.0
  %convolution.3.indvar.dim.0 = load i64, i64* %convolution.3.invar_address.dim.0
...
convolution.3.loop_header.dim.1:                  ; preds = %convolution.3.loop_exit.dim.2, %convolution.3.loop_body.dim.0
  %convolution.3.indvar.dim.1 = load i64, i64* %convolution.3.invar_address.dim.1
...
convolution.3.loop_header.dim.2:                  ; preds = %convolution.3.loop_exit.dim.3, %convolution.3.loop_body.dim.1
  %convolution.3.indvar.dim.2 = load i64, i64* %convolution.3.invar_address.dim.2
...
convolution.3.loop_header.dim.3:                  ; preds = %convolution.3.inner.loop_exit.k0, %convolution.3.loop_body.dim.2
  %convolution.3.indvar.dim.3 = load i64, i64* %convolution.3.invar_address.dim.3
...
convolution.3.inner.loop_header.k0:               ; preds = %convolution.3.inner.loop_exit.k1, %convolution.3.loop_body.dim.3
  %convolution.3.inner.indvar.k0 = load i64, i64* %convolution.3.inner.invar_address.k0
...
convolution.3.inner.loop_header.k1:               ; preds = %convolution.3.inner.loop_exit.iz, %convolution.3.inner.loop_body.k0
  %convolution.3.inner.indvar.k1 = load i64, i64* %convolution.3.inner.invar_address.k1
...
convolution.3.inner.loop_header.iz:               ; preds = %in-bounds-after58, %convolution.3.inner.loop_body.k1
  %convolution.3.inner.indvar.iz = load i64, i64* %convolution.3.inner.invar_address.iz
...
convolution.3.inner.loop_exit.k0:                 ; preds = %convolution.3.inner.loop_header.k0
  %284 = load float, float* %convolution_sum_address52
  %285 = getelementptr inbounds [2 x [13 x [13 x [384 x float]]]], [2 x [13 x [13 x [384 x float]]]]* %convolution.3, i64 0, i64 %convolution.3.indvar.dim.0, i64 %convolution.3.indvar.dim.1, i64 %convolution.3.indvar.dim.2, i64 %convolution.3.indvar.dim.3
...
convolution.3.loop_exit.dim.0:                    ; preds = %convolution.3.loop_header.dim.0
  %286 = getelementptr inbounds i8*, i8** %params, i64 7
  %arg7.untyped = load i8*, i8** %286, !dereferenceable !15, !align !2
  %287 = bitcast i8* %arg7.untyped to [384 x float]*
  %288 = getelementptr inbounds i8*, i8** %temps, i64 25
  %289 = load i8*, i8** %288, !dereferenceable !13, !align !2
  %290 = getelementptr inbounds i8, i8* %289, i64 5385216
...
in-bounds-true56:                                 ; preds = %convolution.3.inner.loop_body.iz
  %291 = getelementptr inbounds [3 x [3 x [256 x [384 x float]]]], [3 x [3 x [256 x [384 x float]]]]* %249, i64 0, i64 %convolution.3.inner.indvar.k0, i64 %convolution.3.inner.indvar.k1, i64 %convolution.3.inner.indvar.iz, i64 %convolution.3.indvar.dim.3
  %292 = load float, float* %291
  %293 = getelementptr inbounds [2 x [13 x [13 x [256 x float]]]], [2 x [13 x [13 x [256 x float]]]]* %reduce-window.3, i64 0, i64 %convolution.3.indvar.dim.0, i64 %282, i64 %283, i64 %convolution.3.inner.indvar.iz
  %294 = load float, float* %293
  %295 = fmul float %294, %292
  %296 = load float, float* %convolution_sum_address52
...
fusion.8.loop_header.dim.0:                       ; preds = %fusion.8.loop_exit.dim.1, %convolution.3.loop_exit.dim.0
  %fusion.8.indvar.dim.0 = load i64, i64* %fusion.8.invar_address.dim.0
...
fusion.8.loop_header.dim.1:                       ; preds = %fusion.8.loop_exit.dim.2, %fusion.8.loop_body.dim.0
  %fusion.8.indvar.dim.1 = load i64, i64* %fusion.8.invar_address.dim.1
...
fusion.8.loop_header.dim.2:                       ; preds = %fusion.8.loop_exit.dim.3, %fusion.8.loop_body.dim.1
  %fusion.8.indvar.dim.2 = load i64, i64* %fusion.8.invar_address.dim.2
...
fusion.8.loop_header.dim.3:                       ; preds = %fusion.8.loop_body.dim.3, %fusion.8.loop_body.dim.2
  %fusion.8.indvar.dim.3 = load i64, i64* %fusion.8.invar_address.dim.3
...
fusion.8.loop_body.dim.3:                         ; preds = %fusion.8.loop_header.dim.3
  ...
  %306 = load float, float* @0
  %307 = getelementptr inbounds [2 x [13 x [13 x [384 x float]]]], [2 x [13 x [13 x [384 x float]]]]* %convolution.3, i64 0, i64 %302, i64 %303, i64 %304, i64 %305
  %308 = load float, float* %307
  %309 = getelementptr inbounds [384 x float], [384 x float]* %287, i64 0, i64 %305
  ...
  %316 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.8, i64 0, i64 %fusion.8.indvar.dim.0, i64 %fusion.8.indvar.dim.1, i64 %fusion.8.indvar.dim.2, i64 %fusion.8.indvar.dim.3
...
fusion.8.loop_exit.dim.0:                         ; preds = %fusion.8.loop_header.dim.0
  %317 = getelementptr inbounds i8*, i8** %params, i64 3
  %arg3.untyped = load i8*, i8** %317, !dereferenceable !3, !align !2
  %318 = bitcast i8* %arg3.untyped to [3 x [3 x [192 x [384 x float]]]]*
  %319 = getelementptr inbounds i8*, i8** %temps, i64 25
  %320 = load i8*, i8** %319, !dereferenceable !13, !align !2
  %321 = getelementptr inbounds i8, i8* %320, i64 884736
  ...
  %322 = getelementptr inbounds i8*, i8** %parallel_slice.1_parameter_addresses, i64 0
  store i8* %parallel_slice.1_parameter_0_address_as_i8ptr, i8** %322
  %323 = bitcast [3 x [3 x [192 x [192 x float]]]]* %call.1 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %323, i8* %run_options, i8** %parallel_slice.1_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_slice.1_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_slice.1 to i8*))
  %324 = getelementptr inbounds i8*, i8** %temps, i64 25
  %325 = load i8*, i8** %324, !dereferenceable !13, !align !2
  %326 = getelementptr inbounds i8, i8* %325, i64 2731008
...
convolution.4.loop_header.dim.0:                  ; preds = %convolution.4.loop_exit.dim.1, %fusion.8.loop_exit.dim.0
  %convolution.4.indvar.dim.0 = load i64, i64* %convolution.4.invar_address.dim.0
...
convolution.4.loop_header.dim.1:                  ; preds = %convolution.4.loop_exit.dim.2, %convolution.4.loop_body.dim.0
  %convolution.4.indvar.dim.1 = load i64, i64* %convolution.4.invar_address.dim.1
...
convolution.4.loop_header.dim.2:                  ; preds = %convolution.4.loop_exit.dim.3, %convolution.4.loop_body.dim.1
  %convolution.4.indvar.dim.2 = load i64, i64* %convolution.4.invar_address.dim.2
...
convolution.4.loop_header.dim.3:                  ; preds = %convolution.4.inner.loop_exit.k0, %convolution.4.loop_body.dim.2
  %convolution.4.indvar.dim.3 = load i64, i64* %convolution.4.invar_address.dim.3
...
convolution.4.inner.loop_header.k0:               ; preds = %convolution.4.inner.loop_exit.k1, %convolution.4.loop_body.dim.3
  %convolution.4.inner.indvar.k0 = load i64, i64* %convolution.4.inner.invar_address.k0
...
convolution.4.inner.loop_header.k1:               ; preds = %convolution.4.inner.loop_exit.iz, %convolution.4.inner.loop_body.k0
  %convolution.4.inner.indvar.k1 = load i64, i64* %convolution.4.inner.invar_address.k1
...
convolution.4.inner.loop_header.iz:               ; preds = %in-bounds-after73, %convolution.4.inner.loop_body.k1
  %convolution.4.inner.indvar.iz = load i64, i64* %convolution.4.inner.invar_address.iz
...
convolution.4.inner.loop_exit.k0:                 ; preds = %convolution.4.inner.loop_header.k0
  %354 = load float, float* %convolution_sum_address67
  %355 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %convolution.4, i64 0, i64 %convolution.4.indvar.dim.0, i64 %convolution.4.indvar.dim.1, i64 %convolution.4.indvar.dim.2, i64 %convolution.4.indvar.dim.3
...
convolution.4.loop_exit.dim.0:                    ; preds = %convolution.4.loop_header.dim.0
  %356 = getelementptr inbounds i8*, i8** %temps, i64 25
  %357 = load i8*, i8** %356, !dereferenceable !13, !align !2
  %358 = getelementptr inbounds i8, i8* %357, i64 2990592
...
in-bounds-true71:                                 ; preds = %convolution.4.inner.loop_body.iz
  %359 = getelementptr inbounds [3 x [3 x [192 x [192 x float]]]], [3 x [3 x [192 x [192 x float]]]]* %call.1, i64 0, i64 %convolution.4.inner.indvar.k0, i64 %convolution.4.inner.indvar.k1, i64 %convolution.4.inner.indvar.iz, i64 %convolution.4.indvar.dim.3
  %360 = load float, float* %359
  %361 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.8, i64 0, i64 %convolution.4.indvar.dim.0, i64 %352, i64 %353, i64 %convolution.4.inner.indvar.iz
  %362 = load float, float* %361
  %363 = fmul float %362, %360
  %364 = load float, float* %convolution_sum_address67
...
fusion.9.loop_header.dim.0:                       ; preds = %fusion.9.loop_exit.dim.1, %convolution.4.loop_exit.dim.0
  %fusion.9.indvar.dim.0 = load i64, i64* %fusion.9.invar_address.dim.0
...
fusion.9.loop_header.dim.1:                       ; preds = %fusion.9.loop_exit.dim.2, %fusion.9.loop_body.dim.0
  %fusion.9.indvar.dim.1 = load i64, i64* %fusion.9.invar_address.dim.1
...
fusion.9.loop_header.dim.2:                       ; preds = %fusion.9.loop_exit.dim.3, %fusion.9.loop_body.dim.1
  %fusion.9.indvar.dim.2 = load i64, i64* %fusion.9.invar_address.dim.2
...
fusion.9.loop_header.dim.3:                       ; preds = %fusion.9.loop_body.dim.3, %fusion.9.loop_body.dim.2
  %fusion.9.indvar.dim.3 = load i64, i64* %fusion.9.invar_address.dim.3
...
fusion.9.loop_body.dim.3:                         ; preds = %fusion.9.loop_header.dim.3
  ...
  %374 = load float, float* @0
  %375 = getelementptr inbounds [2 x [13 x [13 x [384 x float]]]], [2 x [13 x [13 x [384 x float]]]]* %convolution.3, i64 0, i64 %370, i64 %371, i64 %372, i64 %373
  %376 = load float, float* %375
  %377 = getelementptr inbounds [384 x float], [384 x float]* %287, i64 0, i64 %373
  ...
  %384 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.9, i64 0, i64 %fusion.9.indvar.dim.0, i64 %fusion.9.indvar.dim.1, i64 %fusion.9.indvar.dim.2, i64 %fusion.9.indvar.dim.3
...
fusion.9.loop_exit.dim.0:                         ; preds = %fusion.9.loop_header.dim.0
  %385 = getelementptr inbounds i8*, i8** %temps, i64 25
  %386 = load i8*, i8** %385, !dereferenceable !13, !align !2
  %387 = getelementptr inbounds i8, i8* %386, i64 884736
  ...
  %388 = getelementptr inbounds i8*, i8** %parallel_slice.7_parameter_addresses, i64 0
  store i8* %parallel_slice.7_parameter_0_address_as_i8ptr, i8** %388
  %389 = bitcast [3 x [3 x [192 x [192 x float]]]]* %call.7 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %389, i8* %run_options, i8** %parallel_slice.7_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_slice.7_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_slice.7 to i8*))
  %390 = getelementptr inbounds i8*, i8** %temps, i64 25
  %391 = load i8*, i8** %390, !dereferenceable !13, !align !2
  %392 = getelementptr inbounds i8, i8* %391, i64 2211840
...
convolution.5.loop_header.dim.0:                  ; preds = %convolution.5.loop_exit.dim.1, %fusion.9.loop_exit.dim.0
  %convolution.5.indvar.dim.0 = load i64, i64* %convolution.5.invar_address.dim.0
...
convolution.5.loop_header.dim.1:                  ; preds = %convolution.5.loop_exit.dim.2, %convolution.5.loop_body.dim.0
  %convolution.5.indvar.dim.1 = load i64, i64* %convolution.5.invar_address.dim.1
...
convolution.5.loop_header.dim.2:                  ; preds = %convolution.5.loop_exit.dim.3, %convolution.5.loop_body.dim.1
  %convolution.5.indvar.dim.2 = load i64, i64* %convolution.5.invar_address.dim.2
...
convolution.5.loop_header.dim.3:                  ; preds = %convolution.5.inner.loop_exit.k0, %convolution.5.loop_body.dim.2
  %convolution.5.indvar.dim.3 = load i64, i64* %convolution.5.invar_address.dim.3
...
convolution.5.inner.loop_header.k0:               ; preds = %convolution.5.inner.loop_exit.k1, %convolution.5.loop_body.dim.3
  %convolution.5.inner.indvar.k0 = load i64, i64* %convolution.5.inner.invar_address.k0
...
convolution.5.inner.loop_header.k1:               ; preds = %convolution.5.inner.loop_exit.iz, %convolution.5.inner.loop_body.k0
  %convolution.5.inner.indvar.k1 = load i64, i64* %convolution.5.inner.invar_address.k1
...
convolution.5.inner.loop_header.iz:               ; preds = %in-bounds-after88, %convolution.5.inner.loop_body.k1
  %convolution.5.inner.indvar.iz = load i64, i64* %convolution.5.inner.invar_address.iz
...
convolution.5.inner.loop_exit.k0:                 ; preds = %convolution.5.inner.loop_header.k0
  %420 = load float, float* %convolution_sum_address82
  %421 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %convolution.5, i64 0, i64 %convolution.5.indvar.dim.0, i64 %convolution.5.indvar.dim.1, i64 %convolution.5.indvar.dim.2, i64 %convolution.5.indvar.dim.3
...
convolution.5.loop_exit.dim.0:                    ; preds = %convolution.5.loop_header.dim.0
  %422 = getelementptr inbounds i8*, i8** %params, i64 8
  %arg8.untyped = load i8*, i8** %422, !dereferenceable !15, !align !2
  %423 = bitcast i8* %arg8.untyped to [384 x float]*
  %424 = getelementptr inbounds i8*, i8** %temps, i64 25
  %425 = load i8*, i8** %424, !dereferenceable !13, !align !2
  %426 = getelementptr inbounds i8, i8* %425, i64 2471424
...
in-bounds-true86:                                 ; preds = %convolution.5.inner.loop_body.iz
  %427 = getelementptr inbounds [3 x [3 x [192 x [192 x float]]]], [3 x [3 x [192 x [192 x float]]]]* %call.7, i64 0, i64 %convolution.5.inner.indvar.k0, i64 %convolution.5.inner.indvar.k1, i64 %convolution.5.inner.indvar.iz, i64 %convolution.5.indvar.dim.3
  %428 = load float, float* %427
  %429 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.9, i64 0, i64 %convolution.5.indvar.dim.0, i64 %418, i64 %419, i64 %convolution.5.inner.indvar.iz
  %430 = load float, float* %429
  %431 = fmul float %430, %428
  %432 = load float, float* %convolution_sum_address82
...
fusion.6.loop_header.dim.0:                       ; preds = %fusion.6.loop_exit.dim.1, %convolution.5.loop_exit.dim.0
  %fusion.6.indvar.dim.0 = load i64, i64* %fusion.6.invar_address.dim.0
...
fusion.6.loop_header.dim.1:                       ; preds = %fusion.6.loop_exit.dim.2, %fusion.6.loop_body.dim.0
  %fusion.6.indvar.dim.1 = load i64, i64* %fusion.6.invar_address.dim.1
...
fusion.6.loop_header.dim.2:                       ; preds = %fusion.6.loop_exit.dim.3, %fusion.6.loop_body.dim.1
  %fusion.6.indvar.dim.2 = load i64, i64* %fusion.6.invar_address.dim.2
...
fusion.6.loop_header.dim.3:                       ; preds = %concatenate.4.merge, %fusion.6.loop_body.dim.2
  %fusion.6.indvar.dim.3 = load i64, i64* %fusion.6.invar_address.dim.3
...
concat_index_from_operand0:                       ; preds = %fusion.6.loop_body.dim.3
  %444 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %convolution.5, i64 0, i64 %438, i64 %439, i64 %440, i64 %441
...
concat_index_from_operand1:                       ; preds = %concat_index_not_from_operand0
  %448 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %convolution.4, i64 0, i64 %438, i64 %439, i64 %440, i64 %446
...
concatenate.4.merge:                              ; preds = %concat_index_from_operand1, %concat_index_from_operand0
  ...
  %452 = getelementptr inbounds [384 x float], [384 x float]* %423, i64 0, i64 %441
  ...
  %459 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.6, i64 0, i64 %fusion.6.indvar.dim.0, i64 %fusion.6.indvar.dim.1, i64 %fusion.6.indvar.dim.2, i64 %fusion.6.indvar.dim.3
...
fusion.6.loop_exit.dim.0:                         ; preds = %fusion.6.loop_header.dim.0
  %460 = getelementptr inbounds i8*, i8** %params, i64 2
  %arg2.untyped = load i8*, i8** %460, !dereferenceable !1, !align !2
  %461 = bitcast i8* %arg2.untyped to [3 x [3 x [192 x [256 x float]]]]*
  %462 = getelementptr inbounds i8*, i8** %temps, i64 25
  %463 = load i8*, i8** %462, !dereferenceable !13, !align !2
  ...
  %464 = getelementptr inbounds i8*, i8** %parallel_slice_parameter_addresses, i64 0
  store i8* %parallel_slice_parameter_0_address_as_i8ptr, i8** %464
  %465 = bitcast [3 x [3 x [192 x [128 x float]]]]* %call to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %465, i8* %run_options, i8** %parallel_slice_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_slice_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_slice to i8*))
  %466 = getelementptr inbounds i8*, i8** %temps, i64 25
  %467 = load i8*, i8** %466, !dereferenceable !13, !align !2
  %468 = getelementptr inbounds i8, i8* %467, i64 2990592
...
convolution.6.loop_header.dim.0:                  ; preds = %convolution.6.loop_exit.dim.1, %fusion.6.loop_exit.dim.0
  %convolution.6.indvar.dim.0 = load i64, i64* %convolution.6.invar_address.dim.0
...
convolution.6.loop_header.dim.1:                  ; preds = %convolution.6.loop_exit.dim.2, %convolution.6.loop_body.dim.0
  %convolution.6.indvar.dim.1 = load i64, i64* %convolution.6.invar_address.dim.1
...
convolution.6.loop_header.dim.2:                  ; preds = %convolution.6.loop_exit.dim.3, %convolution.6.loop_body.dim.1
  %convolution.6.indvar.dim.2 = load i64, i64* %convolution.6.invar_address.dim.2
...
convolution.6.loop_header.dim.3:                  ; preds = %convolution.6.inner.loop_exit.k0, %convolution.6.loop_body.dim.2
  %convolution.6.indvar.dim.3 = load i64, i64* %convolution.6.invar_address.dim.3
...
convolution.6.inner.loop_header.k0:               ; preds = %convolution.6.inner.loop_exit.k1, %convolution.6.loop_body.dim.3
  %convolution.6.inner.indvar.k0 = load i64, i64* %convolution.6.inner.invar_address.k0
...
convolution.6.inner.loop_header.k1:               ; preds = %convolution.6.inner.loop_exit.iz, %convolution.6.inner.loop_body.k0
  %convolution.6.inner.indvar.k1 = load i64, i64* %convolution.6.inner.invar_address.k1
...
convolution.6.inner.loop_header.iz:               ; preds = %in-bounds-after103, %convolution.6.inner.loop_body.k1
  %convolution.6.inner.indvar.iz = load i64, i64* %convolution.6.inner.invar_address.iz
...
convolution.6.inner.loop_exit.k0:                 ; preds = %convolution.6.inner.loop_header.k0
  %496 = load float, float* %convolution_sum_address97
  %497 = getelementptr inbounds [2 x [13 x [13 x [128 x float]]]], [2 x [13 x [13 x [128 x float]]]]* %convolution.6, i64 0, i64 %convolution.6.indvar.dim.0, i64 %convolution.6.indvar.dim.1, i64 %convolution.6.indvar.dim.2, i64 %convolution.6.indvar.dim.3
...
convolution.6.loop_exit.dim.0:                    ; preds = %convolution.6.loop_header.dim.0
  %498 = getelementptr inbounds i8*, i8** %temps, i64 25
  %499 = load i8*, i8** %498, !dereferenceable !13, !align !2
  %500 = getelementptr inbounds i8, i8* %499, i64 2471424
...
in-bounds-true101:                                ; preds = %convolution.6.inner.loop_body.iz
  %501 = getelementptr inbounds [3 x [3 x [192 x [128 x float]]]], [3 x [3 x [192 x [128 x float]]]]* %call, i64 0, i64 %convolution.6.inner.indvar.k0, i64 %convolution.6.inner.indvar.k1, i64 %convolution.6.inner.indvar.iz, i64 %convolution.6.indvar.dim.3
  %502 = load float, float* %501
  %503 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.6, i64 0, i64 %convolution.6.indvar.dim.0, i64 %494, i64 %495, i64 %convolution.6.inner.indvar.iz
  %504 = load float, float* %503
  %505 = fmul float %504, %502
  %506 = load float, float* %convolution_sum_address97
...
fusion.7.loop_header.dim.0:                       ; preds = %fusion.7.loop_exit.dim.1, %convolution.6.loop_exit.dim.0
  %fusion.7.indvar.dim.0 = load i64, i64* %fusion.7.invar_address.dim.0
...
fusion.7.loop_header.dim.1:                       ; preds = %fusion.7.loop_exit.dim.2, %fusion.7.loop_body.dim.0
  %fusion.7.indvar.dim.1 = load i64, i64* %fusion.7.invar_address.dim.1
...
fusion.7.loop_header.dim.2:                       ; preds = %fusion.7.loop_exit.dim.3, %fusion.7.loop_body.dim.1
  %fusion.7.indvar.dim.2 = load i64, i64* %fusion.7.invar_address.dim.2
...
fusion.7.loop_header.dim.3:                       ; preds = %concatenate.5.merge, %fusion.7.loop_body.dim.2
  %fusion.7.indvar.dim.3 = load i64, i64* %fusion.7.invar_address.dim.3
...
concat_index_from_operand0108:                    ; preds = %fusion.7.loop_body.dim.3
  %518 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %convolution.5, i64 0, i64 %512, i64 %513, i64 %514, i64 %515
...
concat_index_from_operand1110:                    ; preds = %concat_index_not_from_operand0109
  %522 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %convolution.4, i64 0, i64 %512, i64 %513, i64 %514, i64 %520
...
concatenate.5.merge:                              ; preds = %concat_index_from_operand1110, %concat_index_from_operand0108
  ...
  %526 = getelementptr inbounds [384 x float], [384 x float]* %423, i64 0, i64 %515
  %527 = load float, float* %526
  %528 = fadd float %525, %527
  %529 = fcmp oge float %516, %528
  %530 = fcmp une float %516, %516
  %531 = or i1 %529, %530
  %532 = select i1 %531, float %516, float %528
  %533 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.7, i64 0, i64 %fusion.7.indvar.dim.0, i64 %fusion.7.indvar.dim.1, i64 %fusion.7.indvar.dim.2, i64 %fusion.7.indvar.dim.3
...
fusion.7.loop_exit.dim.0:                         ; preds = %fusion.7.loop_header.dim.0
  %534 = getelementptr inbounds i8*, i8** %temps, i64 25
  %535 = load i8*, i8** %534, !dereferenceable !13, !align !2
  ...
  %536 = getelementptr inbounds i8*, i8** %parallel_slice.10_parameter_addresses, i64 0
  store i8* %parallel_slice.10_parameter_0_address_as_i8ptr, i8** %536
  %537 = bitcast [3 x [3 x [192 x [128 x float]]]]* %call.8 to i8*
  call void @__xla_cpu_runtime_ParallelForkJoin(i8* %537, i8* %run_options, i8** %parallel_slice.10_parameter_addresses, i8** %temps, i64* %prof_counters, i32 2, i64* getelementptr inbounds ([4 x i64], [4 x i64]* @parallel_slice.10_parallel_dimension_partitions, i32 0, i32 0), i32 1, i8* bitcast (void (i8*, i8*, i8**, i8**, i64*, i64*)* @parallel_slice.10 to i8*))
  %538 = getelementptr inbounds i8*, i8** %temps, i64 25
  %539 = load i8*, i8** %538, !dereferenceable !13, !align !2
  %540 = getelementptr inbounds i8, i8* %539, i64 2211840
...
convolution.7.loop_header.dim.0:                  ; preds = %convolution.7.loop_exit.dim.1, %fusion.7.loop_exit.dim.0
  %convolution.7.indvar.dim.0 = load i64, i64* %convolution.7.invar_address.dim.0
...
convolution.7.loop_header.dim.1:                  ; preds = %convolution.7.loop_exit.dim.2, %convolution.7.loop_body.dim.0
  %convolution.7.indvar.dim.1 = load i64, i64* %convolution.7.invar_address.dim.1
...
convolution.7.loop_header.dim.2:                  ; preds = %convolution.7.loop_exit.dim.3, %convolution.7.loop_body.dim.1
  %convolution.7.indvar.dim.2 = load i64, i64* %convolution.7.invar_address.dim.2
...
convolution.7.loop_header.dim.3:                  ; preds = %convolution.7.inner.loop_exit.k0, %convolution.7.loop_body.dim.2
  %convolution.7.indvar.dim.3 = load i64, i64* %convolution.7.invar_address.dim.3
...
convolution.7.inner.loop_header.k0:               ; preds = %convolution.7.inner.loop_exit.k1, %convolution.7.loop_body.dim.3
  %convolution.7.inner.indvar.k0 = load i64, i64* %convolution.7.inner.invar_address.k0
...
convolution.7.inner.loop_header.k1:               ; preds = %convolution.7.inner.loop_exit.iz, %convolution.7.inner.loop_body.k0
  %convolution.7.inner.indvar.k1 = load i64, i64* %convolution.7.inner.invar_address.k1
...
convolution.7.inner.loop_header.iz:               ; preds = %in-bounds-after122, %convolution.7.inner.loop_body.k1
  %convolution.7.inner.indvar.iz = load i64, i64* %convolution.7.inner.invar_address.iz
...
convolution.7.inner.loop_exit.k0:                 ; preds = %convolution.7.inner.loop_header.k0
  %568 = load float, float* %convolution_sum_address116
  %569 = getelementptr inbounds [2 x [13 x [13 x [128 x float]]]], [2 x [13 x [13 x [128 x float]]]]* %convolution.7, i64 0, i64 %convolution.7.indvar.dim.0, i64 %convolution.7.indvar.dim.1, i64 %convolution.7.indvar.dim.2, i64 %convolution.7.indvar.dim.3
...
convolution.7.loop_exit.dim.0:                    ; preds = %convolution.7.loop_header.dim.0
  %570 = getelementptr inbounds i8*, i8** %params, i64 9
  %arg9.untyped = load i8*, i8** %570, !dereferenceable !8, !align !2
  %571 = bitcast i8* %arg9.untyped to [256 x float]*
  %572 = getelementptr inbounds i8*, i8** %temps, i64 25
  %573 = load i8*, i8** %572, !dereferenceable !13, !align !2
  %574 = getelementptr inbounds i8, i8* %573, i64 2384896
...
in-bounds-true120:                                ; preds = %convolution.7.inner.loop_body.iz
  %575 = getelementptr inbounds [3 x [3 x [192 x [128 x float]]]], [3 x [3 x [192 x [128 x float]]]]* %call.8, i64 0, i64 %convolution.7.inner.indvar.k0, i64 %convolution.7.inner.indvar.k1, i64 %convolution.7.inner.indvar.iz, i64 %convolution.7.indvar.dim.3
  %576 = load float, float* %575
  %577 = getelementptr inbounds [2 x [13 x [13 x [192 x float]]]], [2 x [13 x [13 x [192 x float]]]]* %fusion.7, i64 0, i64 %convolution.7.indvar.dim.0, i64 %566, i64 %567, i64 %convolution.7.inner.indvar.iz
  %578 = load float, float* %577
  %579 = fmul float %578, %576
  %580 = load float, float* %convolution_sum_address116
...
fusion.5.loop_header.dim.2:                       ; preds = %fusion.5.loop_exit.dim.3, %fusion.5.loop_body.dim.1
  %fusion.5.indvar.dim.2 = load i64, i64* %fusion.5.invar_address.dim.2
...
fusion.5.loop_header.dim.3:                       ; preds = %concatenate.3.merge, %fusion.5.loop_body.dim.2
  %fusion.5.indvar.dim.3 = load i64, i64* %fusion.5.invar_address.dim.3
...
concat_index_from_operand0127:                    ; preds = %fusion.5.loop_body.dim.3
  %588 = getelementptr inbounds [2 x [13 x [13 x [128 x float]]]], [2 x [13 x [13 x [128 x float]]]]* %convolution.7, i64 0, i64 %fusion.5.indvar.dim.0, i64 %fusion.5.indvar.dim.1, i64 %fusion.5.indvar.dim.2, i64 %fusion.5.indvar.dim.3
...
concat_index_from_operand1129:                    ; preds = %concat_index_not_from_operand0128
  %592 = getelementptr inbounds [2 x [13 x [13 x [128 x float]]]], [2 x [13 x [13 x [128 x float]]]]* %convolution.6, i64 0, i64 %fusion.5.indvar.dim.0, i64 %fusion.5.indvar.dim.1, i64 %fusion.5.indvar.dim.2, i64 %590
...
concatenate.3.merge:                              ; preds = %concat_index_from_operand1129, %concat_index_from_operand0127
  ...
  %596 = getelementptr inbounds [256 x float], [256 x float]* %571, i64 0, i64 %fusion.5.indvar.dim.3
  %597 = load float, float* %596
  %598 = fadd float %595, %597
  %599 = fcmp oge float %586, %598
  %600 = fcmp une float %586, %586
  %601 = or i1 %599, %600
  %602 = select i1 %601, float %586, float %598
  %603 = getelementptr inbounds [2 x [13 x [13 x [256 x float]]]], [2 x [13 x [13 x [256 x float]]]]* %fusion.5, i64 0, i64 %fusion.5.indvar.dim.0, i64 %fusion.5.indvar.dim.1, i64 %fusion.5.indvar.dim.2, i64 %fusion.5.indvar.dim.3
...
fusion.5.loop_exit.dim.0:                         ; preds = %fusion.5.loop_header.dim.0
  %604 = getelementptr inbounds i8*, i8** %temps, i64 25
  %605 = load i8*, i8** %604, !dereferenceable !13, !align !2
  %606 = getelementptr inbounds i8, i8* %605, i64 2211840
...
reduce-window.4.loop_header.dim.0:                ; preds = %reduce-window.4.loop_exit.dim.1, %fusion.5.loop_exit.dim.0
  %reduce-window.4.indvar.dim.0 = load i64, i64* %reduce-window.4.invar_address.dim.0
...
reduce-window.4.loop_header.dim.1:                ; preds = %reduce-window.4.loop_exit.dim.2, %reduce-window.4.loop_body.dim.0
  %reduce-window.4.indvar.dim.1 = load i64, i64* %reduce-window.4.invar_address.dim.1
...
reduce-window.4.loop_header.dim.2:                ; preds = %reduce-window.4.loop_exit.dim.3, %reduce-window.4.loop_body.dim.1
  %reduce-window.4.indvar.dim.2 = load i64, i64* %reduce-window.4.invar_address.dim.2
...
reduce-window.4.loop_header.dim.3:                ; preds = %reduce-window.4.inner.loop_exit.window.0, %reduce-window.4.loop_body.dim.2
  %reduce-window.4.indvar.dim.3 = load i64, i64* %reduce-window.4.invar_address.dim.3
...
reduce-window.4.inner.loop_header.window.0:       ; preds = %reduce-window.4.inner.loop_exit.window.1, %reduce-window.4.loop_body.dim.3
  %reduce-window.4.inner.indvar.window.0 = load i64, i64* %reduce-window.4.inner.invar_address.window.0
...
reduce-window.4.inner.loop_header.window.1:       ; preds = %reduce-window.4.inner.loop_exit.window.2, %reduce-window.4.inner.loop_body.window.0
  %reduce-window.4.inner.indvar.window.1 = load i64, i64* %reduce-window.4.inner.invar_address.window.1
...
reduce-window.4.inner.loop_header.window.2:       ; preds = %reduce-window.4.inner.loop_exit.window.3, %reduce-window.4.inner.loop_body.window.1
  %reduce-window.4.inner.indvar.window.2 = load i64, i64* %reduce-window.4.inner.invar_address.window.2
...
reduce-window.4.inner.loop_header.window.3:       ; preds = %in-bounds-after142, %reduce-window.4.inner.loop_body.window.2
  %reduce-window.4.inner.indvar.window.3 = load i64, i64* %reduce-window.4.inner.invar_address.window.3
...
reduce-window.4.inner.loop_exit.window.0:         ; preds = %reduce-window.4.inner.loop_header.window.0
  %635 = load float, float* %reduce_window_accumulator_address135
  %636 = getelementptr inbounds [2 x [6 x [6 x [256 x float]]]], [2 x [6 x [6 x [256 x float]]]]* %reduce-window.4, i64 0, i64 %reduce-window.4.indvar.dim.0, i64 %reduce-window.4.indvar.dim.1, i64 %reduce-window.4.indvar.dim.2, i64 %reduce-window.4.indvar.dim.3
...
reduce-window.4.loop_exit.dim.0:                  ; preds = %reduce-window.4.loop_header.dim.0
  ...
  %637 = getelementptr inbounds i8*, i8** %params, i64 10
  %arg10.untyped = load i8*, i8** %637, !dereferenceable !16, !align !2
  %638 = bitcast i8* %arg10.untyped to [9216 x [4096 x float]]*
  %639 = getelementptr inbounds i8*, i8** %temps, i64 25
  %640 = load i8*, i8** %639, !dereferenceable !13, !align !2
  %641 = getelementptr inbounds i8, i8* %640, i64 2285568
...
in-bounds-true140:                                ; preds = %reduce-window.4.inner.loop_body.window.3
  %642 = getelementptr inbounds [2 x [13 x [13 x [256 x float]]]], [2 x [13 x [13 x [256 x float]]]]* %fusion.5, i64 0, i64 %618, i64 %622, i64 %627, i64 %632
  %reducer_function_parameter_0_address_as_i8ptr145 = bitcast float* %reduce_window_accumulator_address135 to i8*
  %643 = getelementptr inbounds i8*, i8** %reducer_function_parameter_addresses144, i64 0
  ...
  %644 = getelementptr inbounds i8*, i8** %reducer_function_parameter_addresses144, i64 1
  ...
  %reducer_function_return_value147 = load float, float* %reducer_function_return_value_address143
...
dot.loop_body.reduction:                          ; preds = %dot.loop_header.reduction
  %649 = getelementptr inbounds [2 x [9216 x float]], [2 x [9216 x float]]* %bitcast, i64 0, i64 %dot.indvar.lhs.0, i64 %dot.indvar.reduction
  %650 = load float, float* %649
  %651 = getelementptr inbounds [9216 x [4096 x float]], [9216 x [4096 x float]]* %638, i64 0, i64 %dot.indvar.reduction, i64 %dot.indvar.rhs.1
  %652 = load float, float* %651
  %653 = load float, float* %accum_address
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_header.reduction
  %656 = load float, float* %accum_address
  %657 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %dot, i64 0, i64 %dot.indvar.lhs.0, i64 %dot.indvar.rhs.1
...
dot.loop_exit.lhs.0:                              ; preds = %dot.loop_header.lhs.0
  %658 = getelementptr inbounds i8*, i8** %params, i64 11
  %arg11.untyped = load i8*, i8** %658, !dereferenceable !17, !align !2
  %659 = bitcast i8* %arg11.untyped to [4096 x float]*
  %660 = getelementptr inbounds i8*, i8** %temps, i64 25
  %661 = load i8*, i8** %660, !dereferenceable !13, !align !2
  %662 = getelementptr inbounds i8, i8* %661, i64 2211840
...
fusion.4.loop_body.dim.1:                         ; preds = %fusion.4.loop_header.dim.1
  %665 = load float, float* @0
  %666 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %dot, i64 0, i64 %fusion.4.indvar.dim.0, i64 %fusion.4.indvar.dim.1
  %667 = load float, float* %666
  %668 = getelementptr inbounds [4096 x float], [4096 x float]* %659, i64 0, i64 %fusion.4.indvar.dim.1
  ...
  %675 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %fusion.4, i64 0, i64 %fusion.4.indvar.dim.0, i64 %fusion.4.indvar.dim.1
...
fusion.4.loop_exit.dim.0:                         ; preds = %fusion.4.loop_header.dim.0
  %676 = getelementptr inbounds i8*, i8** %params, i64 12
  %arg12.untyped = load i8*, i8** %676, !dereferenceable !18, !align !2
  %677 = bitcast i8* %arg12.untyped to [4096 x [4096 x float]]*
  %678 = getelementptr inbounds i8*, i8** %temps, i64 25
  %679 = load i8*, i8** %678, !dereferenceable !13, !align !2
  %680 = getelementptr inbounds i8, i8* %679, i64 2244608
...
dot.1.loop_header.rhs.1:                          ; preds = %dot.1.loop_exit.reduction, %dot.1.loop_body.lhs.0
  %dot.1.indvar.rhs.1 = load i64, i64* %dot.1.invar_address.rhs.1
...
dot.1.loop_body.reduction:                        ; preds = %dot.1.loop_header.reduction
  %684 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %fusion.4, i64 0, i64 %dot.1.indvar.lhs.0, i64 %dot.1.indvar.reduction
  %685 = load float, float* %684
  %686 = getelementptr inbounds [4096 x [4096 x float]], [4096 x [4096 x float]]* %677, i64 0, i64 %dot.1.indvar.reduction, i64 %dot.1.indvar.rhs.1
  %687 = load float, float* %686
  %688 = load float, float* %accum_address156
...
dot.1.loop_exit.reduction:                        ; preds = %dot.1.loop_header.reduction
  %691 = load float, float* %accum_address156
  %692 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %dot.1, i64 0, i64 %dot.1.indvar.lhs.0, i64 %dot.1.indvar.rhs.1
...
dot.1.loop_exit.lhs.0:                            ; preds = %dot.1.loop_header.lhs.0
  %693 = getelementptr inbounds i8*, i8** %params, i64 13
  %arg13.untyped = load i8*, i8** %693, !dereferenceable !17, !align !2
  %694 = bitcast i8* %arg13.untyped to [4096 x float]*
  %695 = getelementptr inbounds i8*, i8** %temps, i64 25
  %696 = load i8*, i8** %695, !dereferenceable !13, !align !2
  %697 = getelementptr inbounds i8, i8* %696, i64 2211840
...
fusion.3.loop_body.dim.1:                         ; preds = %fusion.3.loop_header.dim.1
  %700 = load float, float* @0
  %701 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %dot.1, i64 0, i64 %fusion.3.indvar.dim.0, i64 %fusion.3.indvar.dim.1
  %702 = load float, float* %701
  %703 = getelementptr inbounds [4096 x float], [4096 x float]* %694, i64 0, i64 %fusion.3.indvar.dim.1
  ...
  %710 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %fusion.3, i64 0, i64 %fusion.3.indvar.dim.0, i64 %fusion.3.indvar.dim.1
...
fusion.3.loop_exit.dim.0:                         ; preds = %fusion.3.loop_header.dim.0
  %711 = getelementptr inbounds i8*, i8** %params, i64 14
  %arg14.untyped = load i8*, i8** %711, !dereferenceable !19, !align !2
  %712 = bitcast i8* %arg14.untyped to [4096 x [1000 x float]]*
  %713 = getelementptr inbounds i8*, i8** %temps, i64 19
  %714 = load i8*, i8** %713, !dereferenceable !20, !align !2
...
dot.2.loop_header.lhs.0:                          ; preds = %dot.2.loop_exit.rhs.1, %fusion.3.loop_exit.dim.0
  %dot.2.indvar.lhs.0 = load i64, i64* %dot.2.invar_address.lhs.0
...
dot.2.loop_header.rhs.1:                          ; preds = %dot.2.loop_exit.reduction, %dot.2.loop_body.lhs.0
  %dot.2.indvar.rhs.1 = load i64, i64* %dot.2.invar_address.rhs.1
...
dot.2.loop_header.reduction:                      ; preds = %dot.2.loop_body.reduction, %dot.2.loop_body.rhs.1
  %dot.2.indvar.reduction = load i64, i64* %dot.2.invar_address.reduction
...
dot.2.loop_body.reduction:                        ; preds = %dot.2.loop_header.reduction
  %718 = getelementptr inbounds [2 x [4096 x float]], [2 x [4096 x float]]* %fusion.3, i64 0, i64 %dot.2.indvar.lhs.0, i64 %dot.2.indvar.reduction
  %719 = load float, float* %718
  %720 = getelementptr inbounds [4096 x [1000 x float]], [4096 x [1000 x float]]* %712, i64 0, i64 %dot.2.indvar.reduction, i64 %dot.2.indvar.rhs.1
  %721 = load float, float* %720
  %722 = load float, float* %accum_address162
...
dot.2.loop_exit.reduction:                        ; preds = %dot.2.loop_header.reduction
  %725 = load float, float* %accum_address162
  %726 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %dot.2, i64 0, i64 %dot.2.indvar.lhs.0, i64 %dot.2.indvar.rhs.1
...
dot.2.loop_exit.lhs.0:                            ; preds = %dot.2.loop_header.lhs.0
  %727 = getelementptr inbounds i8*, i8** %params, i64 15
  %arg15.untyped = load i8*, i8** %727, !dereferenceable !21, !align !2
  %728 = bitcast i8* %arg15.untyped to [1000 x float]*
  %729 = getelementptr inbounds i8*, i8** %temps, i64 25
  %730 = load i8*, i8** %729, !dereferenceable !13, !align !2
  %731 = getelementptr inbounds i8, i8* %730, i64 2211840
...
fusion.2.loop_body.dim.1:                         ; preds = %fusion.2.loop_header.dim.1
  %734 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %dot.2, i64 0, i64 %fusion.2.indvar.dim.0, i64 %fusion.2.indvar.dim.1
  %735 = load float, float* %734
  %736 = getelementptr inbounds [1000 x float], [1000 x float]* %728, i64 0, i64 %fusion.2.indvar.dim.1
  %737 = load float, float* %736
  %738 = fadd float %735, %737
  %739 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %fusion.2, i64 0, i64 %fusion.2.indvar.dim.0, i64 %fusion.2.indvar.dim.1
...
fusion.2.loop_exit.dim.0:                         ; preds = %fusion.2.loop_header.dim.0
  %740 = getelementptr inbounds i8*, i8** %temps, i64 25
  %741 = load i8*, i8** %740, !dereferenceable !13, !align !2
  %742 = getelementptr inbounds i8, i8* %741, i64 2219840
...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %746 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %fusion.2, i64 0, i64 %reduce.indvar.dim.0, i64 %reduce.inner.indvar.reduction_dim.1
  %reduce_function_parameter_0_address_as_i8ptr = bitcast float* %accumulator to i8*
  %747 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses, i64 0
  ...
  %748 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses, i64 1
...
reduce.inner.loop_exit.reduction_dim.1:           ; preds = %reduce.inner.loop_header.reduction_dim.1
  %750 = load float, float* %accumulator
  %751 = getelementptr inbounds [2 x float], [2 x float]* %reduce, i64 0, i64 %reduce.indvar.dim.0
...
reduce.loop_exit.dim.0:                           ; preds = %reduce.loop_header.dim.0
  %752 = getelementptr inbounds i8*, i8** %temps, i64 25
  %753 = load i8*, i8** %752, !dereferenceable !13, !align !2
  %754 = getelementptr inbounds i8, i8* %753, i64 2211840
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_header.dim.1
  %757 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %dot.2, i64 0, i64 %fusion.1.indvar.dim.0, i64 %fusion.1.indvar.dim.1
  %758 = load float, float* %757
  %759 = getelementptr inbounds [1000 x float], [1000 x float]* %728, i64 0, i64 %fusion.1.indvar.dim.1
  %760 = load float, float* %759
  %761 = fadd float %758, %760
  %762 = getelementptr inbounds [2 x float], [2 x float]* %reduce, i64 0, i64 %fusion.1.indvar.dim.0
  %763 = load float, float* %762
  %764 = fsub float %761, %763
  %765 = call float @llvm.exp.f32(float %764)
  %766 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %fusion.1, i64 0, i64 %fusion.1.indvar.dim.0, i64 %fusion.1.indvar.dim.1
...
fusion.1.loop_exit.dim.0:                         ; preds = %fusion.1.loop_header.dim.0
  %767 = getelementptr inbounds i8*, i8** %temps, i64 25
  %768 = load i8*, i8** %767, !dereferenceable !13, !align !2
  %769 = getelementptr inbounds i8, i8* %768, i64 2219840
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %773 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %fusion.1, i64 0, i64 %reduce.1.indvar.dim.0, i64 %reduce.1.inner.indvar.reduction_dim.1
  %reduce_function_parameter_0_address_as_i8ptr174 = bitcast float* %accumulator170 to i8*
  %774 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses173, i64 0
  ...
  %775 = getelementptr inbounds i8*, i8** %reduce_function_parameter_addresses173, i64 1
  ...
  %reduce_function_return_value176 = load float, float* %reduce_function_return_value_address172
...
reduce.1.inner.loop_exit.reduction_dim.1:         ; preds = %reduce.1.inner.loop_header.reduction_dim.1
  %777 = load float, float* %accumulator170
  %778 = getelementptr inbounds [2 x float], [2 x float]* %reduce.1, i64 0, i64 %reduce.1.indvar.dim.0
...
reduce.1.loop_exit.dim.0:                         ; preds = %reduce.1.loop_header.dim.0
  %779 = getelementptr inbounds i8*, i8** %temps, i64 19
  %780 = load i8*, i8** %779, !dereferenceable !20, !align !2
...
fusion.loop_body.dim.1:                           ; preds = %fusion.loop_header.dim.1
  %783 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %fusion.1, i64 0, i64 %fusion.indvar.dim.0, i64 %fusion.indvar.dim.1
  %784 = load float, float* %783
  %785 = getelementptr inbounds [2 x float], [2 x float]* %reduce.1, i64 0, i64 %fusion.indvar.dim.0
  %786 = load float, float* %785
  %787 = fdiv float %784, %786
  %788 = getelementptr inbounds [2 x [1000 x float]], [2 x [1000 x float]]* %fusion, i64 0, i64 %fusion.indvar.dim.0, i64 %fusion.indvar.dim.1
...
fusion.loop_exit.dim.0:                           ; preds = %fusion.loop_header.dim.0
  ...
  %789 = getelementptr inbounds [1 x i8*], [1 x i8*]* %tuple.1, i64 0, i64 0
